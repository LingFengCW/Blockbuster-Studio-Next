...
public class UIFilmPlayerSettingsOverlayPanel extends UIMessageBarOverlayPanel
{
    ...
    public UIFilmPlayerSettingsOverlayPanel(Film film)
    {
        ...
        this.editor = UI.scrollView(5, 6,
            ...
            this.hp,
            UI.label(UIKeys.FILM_PLAYER_SETTINGS_HUNGER).marginTop(3),
            this.hunger,
            UI.label(UIKeys.FILM_PLAYER_SETTINGS_XP_LEVEL).marginTop(3),
            this.xpLevel,
            UI.label(UIKeys.FILM_PLAYER_SETTINGS_XP_PROGRESS).marginTop(3),
            this.xpProgress,
