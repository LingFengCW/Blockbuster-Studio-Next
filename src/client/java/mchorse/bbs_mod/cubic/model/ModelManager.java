...
import mchorse.bbs_mod.cubic.model.loaders.BOBJModelBakery;
import mchorse.bbs_mod.cubic.model.loaders.CubicModelBakery;
import mchorse.bbs_mod.cubic.model.loaders.GeoCubicModelBakery;
import mchorse.bbs_mod.cubic.model.loaders.IModelLoader;
import mchorse.bbs_mod.cubic.model.loaders.VoxModelBakery;
...
public class ModelManager implements IWatchDogListener
{
    ...
    private ModelBakery loader = new ModelBakery(this);
    ...
    {
        this.loaders.clear();
        this.loaders.add(new BOBJModelBakery());
        this.loaders.add(new CubicModelBakery());
        this.loaders.add(new GeoCubicModelBakery());
        this.loaders.add(new VoxModelBakery());
    }
