...
public class RealmsConnect {
    ...
    public void connect(final RealmsServer server, ServerAddress hostAndPort) {
        ...
        minecraft.getNarrator().saySystemNow((Component)Component.translatable((String)"mco.connect.success"));
        ...
        new Thread(this, "Realms-connect-task"){
            ...
            public void run() {
                ...
                try {
                    ...
                    this.this$0.connection = Connection.connectToServer((InetSocketAddress)address, (EventLoopGroupHolder)EventLoopGroupHolder.remote((boolean)minecraft.options.useNativeTransport()), (LocalSampleLogger)minecraft.getDebugOverlay().getBandwidthLogger());
                    if (this.this$0.aborted) {
                        return;
                    }
                    ...
                    this.this$0.connection.initiateServerboundPlayConnection(hostname, port, (ClientLoginPacketListener)clientHandshakePacketListener);
                    if (this.this$0.aborted) {
                        return;
                    }
                    ...
                    DisconnectedScreen screen = new DisconnectedScreen(this.this$0.onlineScreen, (Component)Component.translatable((String)"mco.connect.failed"), (Component)Component.translatable((String)"disconnect.genericReason", (Object[])new Object[]{message}), CommonComponents.GUI_BACK);
    ...
    public void abort() {
        ...
        if (this.connection != null && this.connection.isConnected()) {
            this.connection.disconnect((Component)Component.translatable((String)"disconnect.genericReason"));
