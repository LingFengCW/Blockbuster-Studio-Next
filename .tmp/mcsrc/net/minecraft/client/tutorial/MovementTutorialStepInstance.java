...
implements TutorialStepInstance {
    ...
    private static final Component MOVE_TITLE = Component.translatable((String)"tutorial.move.title", (Object[])new Object[]{Tutorial.key("forward"), Tutorial.key("left"), Tutorial.key("back"), Tutorial.key("right")});
    private static final Component MOVE_DESCRIPTION = Component.translatable((String)"tutorial.move.description", (Object[])new Object[]{Tutorial.key("jump")});
    private static final Component LOOK_TITLE = Component.translatable((String)"tutorial.look.title");
    private static final Component LOOK_DESCRIPTION = Component.translatable((String)"tutorial.look.description");
