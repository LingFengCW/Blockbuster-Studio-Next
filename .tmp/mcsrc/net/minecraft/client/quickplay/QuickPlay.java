...
public class QuickPlay {
    ...
    public static final Component ERROR_TITLE = Component.translatable((String)"quickplay.error.title");
    private static final Component INVALID_IDENTIFIER = Component.translatable((String)"quickplay.error.invalid_identifier");
    private static final Component REALM_CONNECT = Component.translatable((String)"quickplay.error.realm_connect");
    private static final Component REALM_PERMISSION = Component.translatable((String)"quickplay.error.realm_permission");
    private static final Component TO_TITLE = Component.translatable((String)"gui.toTitle");
    private static final Component TO_WORLD_LIST = Component.translatable((String)"gui.toWorld");
    private static final Component TO_REALMS_LIST = Component.translatable((String)"gui.toRealms");
    ...
    public static void connect(Minecraft minecraft, GameConfig.QuickPlayVariant quickPlayVariant, RealmsClient realmsClient) {
        ...
        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{GameConfig.QuickPlayMultiplayerData.class, GameConfig.QuickPlayRealmsData.class, GameConfig.QuickPlaySinglePlayerData.class, GameConfig.QuickPlayDisabled.class}, (GameConfig.QuickPlayVariant)quickPlayVariant3, n)) {
            ...
            case 2: {
                ...
                if (StringUtil.isBlank((String)worldId)) {
    ...
    private static @Nullable String getLatestSingleplayerWorld(LevelStorageSource levelSource) {
        try {
            List levels = (List)levelSource.loadLevelSummaries(levelSource.findLevelCandidates()).get();
            if (levels.isEmpty()) {
    ...
    private static void joinSingleplayerWorld(Minecraft minecraft, @Nullable String identifier) {
        if (StringUtil.isBlank((String)identifier) || !minecraft.getLevelSource().levelExists(identifier)) {
