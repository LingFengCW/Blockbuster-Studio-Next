...
public class QuickPlayLog {
    ...
    public void log(Minecraft minecraft) {
        ...
        Util.ioPool().execute(() -> {
            ...
            Codec.list(QuickPlayEntry.CODEC).encodeStart((DynamicOps)JsonOps.INSTANCE, List.of(quickPlayEntry)).resultOrPartial(Util.prefix((String)"Quick Play: ", arg_0 -> ((Logger)LOGGER).error(arg_0))).ifPresent(json -> {
                try {
