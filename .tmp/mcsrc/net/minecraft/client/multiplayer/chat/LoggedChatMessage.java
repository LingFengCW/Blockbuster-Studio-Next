...
extends LoggedChatEvent {
    ...
    public record Player(GameProfile profile, PlayerChatMessage message, ChatTrustLevel trustLevel) implements LoggedChatMessage
    {
        ...
        private static final DateTimeFormatter TIME_FORMATTER = Util.localizedDateFormatter((FormatStyle)FormatStyle.SHORT);
        ...
        public Component toNarrationComponent() {
            ...
            return Component.translatable((String)"gui.chatSelection.message.narrate", (Object[])new Object[]{this.profile.name(), content, time});
        }

        public Component toHeadingComponent() {
            Component time = this.getTimeComponent();
            return Component.translatable((String)"gui.chatSelection.heading", (Object[])new Object[]{this.profile.name(), time});
        }
        ...
        private Component getTimeComponent() {
            ...
            return Component.literal((String)dateTime.format(TIME_FORMATTER)).withStyle(new ChatFormatting[]{ChatFormatting.ITALIC, ChatFormatting.GRAY});
        }
