...
public interface AbuseReportSender {
    ...
    {
        private static final Component SERVICE_UNAVAILABLE_TEXT = Component.translatable((String)"gui.abuseReport.send.service_unavailable");
        private static final Component HTTP_ERROR_TEXT = Component.translatable((String)"gui.abuseReport.send.http_error");
        private static final Component JSON_ERROR_TEXT = Component.translatable((String)"gui.abuseReport.send.json_error");
        ...
        public CompletableFuture<Unit> send(UUID id, ReportType reportType, AbuseReport report) {
            return CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    throw new CompletionException((Throwable)((Object)new SendException(description, e)));
                }
        ...
        private Component getHttpErrorDescription(MinecraftClientHttpException e) {
            return Component.translatable((String)"gui.abuseReport.send.error_message", (Object[])new Object[]{e.getMessage()});
        }
