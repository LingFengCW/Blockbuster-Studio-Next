...
public final class ReportingContext {
    ...
    public void draftReportHandled(Minecraft minecraft, Screen lastScreen, Runnable onDiscard, boolean quitToTitle) {
        if (this.draftReport != null) {
            ...
            }, (Component)Component.translatable((String)(quitToTitle ? "gui.abuseReport.draft.quittotitle.title" : "gui.abuseReport.draft.title")), (Component)Component.translatable((String)(quitToTitle ? "gui.abuseReport.draft.quittotitle.content" : "gui.abuseReport.draft.content")), (Component)Component.translatable((String)"gui.abuseReport.draft.edit"), (Component)Component.translatable((String)"gui.abuseReport.draft.discard")));
        } else {
            onDiscard.run();
        }
    }
