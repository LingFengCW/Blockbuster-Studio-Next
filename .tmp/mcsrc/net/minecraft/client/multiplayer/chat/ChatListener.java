...
public class ChatListener {
    private static final Component CHAT_VALIDATION_ERROR = Component.translatable((String)"chat.validation_error").withStyle(new ChatFormatting[]{ChatFormatting.RED, ChatFormatting.ITALIC});
    ...
    public boolean removeFromDelayedMessageQueue(MessageSignature signature) {
        return this.delayedMessageQueue.removeIf(message -> signature.equals((Object)message.signature()));
    }
    ...
    private UUID guessChatUUID(Component message) {
        String noFormatMessage = StringDecomposer.getPlainText((FormattedText)message);
