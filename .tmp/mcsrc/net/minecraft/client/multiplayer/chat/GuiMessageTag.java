...
public record GuiMessageTag(int indicatorColor, @Nullable Icon icon, @Nullable Component text, @Nullable String logTag) {
    private static final Component SYSTEM_TEXT = Component.translatable((String)"chat.tag.system");
    private static final Component SYSTEM_TEXT_SINGLE_PLAYER = Component.translatable((String)"chat.tag.system_single_player");
    private static final Component CHAT_NOT_SECURE_TEXT = Component.translatable((String)"chat.tag.not_secure");
    private static final Component CHAT_MODIFIED_TEXT = Component.translatable((String)"chat.tag.modified");
    private static final Component CHAT_ERROR_TEXT = Component.translatable((String)"chat.tag.error");
    ...
    public static GuiMessageTag chatModified(String originalContent) {
        MutableComponent decoratedOriginal = Component.literal((String)originalContent).withStyle(ChatFormatting.GRAY);
        MutableComponent text = Component.empty().append(CHAT_MODIFIED_TEXT).append(CommonComponents.NEW_LINE).append((Component)decoratedOriginal);
        return new GuiMessageTag(0x606060, Icon.CHAT_MODIFIED, (Component)text, "Modified");
    }
    ...
    public static enum Icon {
        CHAT_MODIFIED(Identifier.withDefaultNamespace((String)"icon/chat_modified"), 9, 9);
