...
public class ServerData {
    ...
    public // Could not load outer class - annotation placement on inner may be incorrect
     @Nullable ServerStatus.Players players;
    public long ping;
    public int protocol = SharedConstants.getCurrentVersion().protocolVersion();
    public Component version = Component.literal((String)SharedConstants.getCurrentVersion().name());
    ...
    public CompoundTag write() {
        ...
        tag.storeNullable("icon", ExtraCodecs.BASE64_STRING, (Object)this.iconBytes);
        tag.store(ServerPackStatus.FIELD_CODEC, (Object)this.packStatus);
    ...
    public static byte @Nullable [] validateIcon(byte @Nullable [] bytes) {
        if (bytes != null) {
            try {
                PngInfo iconInfo = PngInfo.fromBytes((byte[])bytes);
    ...
    public static enum ServerPackStatus {
        ...
        private ServerPackStatus(String name) {
            this.name = Component.translatable((String)("manageServer.resourcePack." + name));
        }
