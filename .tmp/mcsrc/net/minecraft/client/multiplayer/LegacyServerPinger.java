...
extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        try {
            ...
            LegacyProtocolUtils.writeLegacyString((ByteBuf)toSend, (String)"MC|PingHost");
            int sizeIndex = toSend.writerIndex();
            toSend.writeShort(0);
            int payloadStart = toSend.writerIndex();
            toSend.writeByte(127);
            LegacyProtocolUtils.writeLegacyString((ByteBuf)toSend, (String)this.address.getHost());
    ...
    protected void channelRead0(ChannelHandlerContext ctx, ByteBuf msg) {
        ...
        if (firstByte == 255 && "\u00a71".equals((split = SPLITTER.splitToList((CharSequence)(str = LegacyProtocolUtils.readLegacyString((ByteBuf)msg)))).get(0))) {
            int protocolVersion = Mth.getInt((String)((String)split.get(1)), (int)0);
            String version = (String)split.get(2);
            String motd = (String)split.get(3);
            int curPlayers = Mth.getInt((String)((String)split.get(4)), (int)-1);
            int maxPlayers = Mth.getInt((String)((String)split.get(5)), (int)-1);
