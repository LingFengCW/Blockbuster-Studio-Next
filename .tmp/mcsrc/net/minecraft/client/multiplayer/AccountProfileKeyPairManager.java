...
implements ProfileKeyPairManager {
    ...
    private Optional<ProfileKeyPair> readProfileKeyPair() {
        ...
        block9: {
            ...
            try {
                optional = ProfileKeyPair.CODEC.parse((DynamicOps)JsonOps.INSTANCE, (Object)StrictJsonParser.parse((Reader)bufferedReader)).result();
    ...
    private @Nullable ProfileKeyPair fetchProfileKeyPair(UserApiService userApiService) throws CryptException, IOException {
        ...
        if (keyPair != null) {
            ...
            return new ProfileKeyPair(Crypt.stringToPemRsaPrivateKey((String)keyPair.keyPair().privateKey()), new ProfilePublicKey(publicKeyData), Instant.parse(keyPair.refreshedAfter()));
        }
        return null;
    }
    ...
    private static ProfilePublicKey.Data parsePublicKey(KeyPairResponse response) throws CryptException {
        ...
        try {
            ...
            PublicKey key = Crypt.stringToRsaPublicKey((String)keyPair.publicKey());
