...
extends RecipeBook {
    ...
    public void rebuildCollections() {
        ...
        recipeListsByCategory.forEach((category, categoryRecipes) -> byCategory.put((SearchRecipeBookCategory)((Object)category), (List)categoryRecipes.stream().map(RecipeCollection::new).peek(arg_0 -> ((ImmutableList.Builder)all).add(arg_0)).collect(ImmutableList.toImmutableList())));
