...
extends SimplePreparableReloadListener<Preparations> {
    ...
    private static final Identifier GPU_WARNLIST_LOCATION = Identifier.withDefaultNamespace((String)"gpu_warnlist.json");
    ...
    private static @Nullable JsonObject parseJson(ResourceManager manager, ProfilerFiller profiler) {
        try (Zone ignored = profiler.zone("parse_json");){
            ...
            block14: {
                ...
                try {
                    jsonObject = StrictJsonParser.parse((Reader)resource).getAsJsonObject();
