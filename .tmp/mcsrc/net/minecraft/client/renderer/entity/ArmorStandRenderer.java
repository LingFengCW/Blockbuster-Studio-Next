...
extends LivingEntityRenderer<ArmorStand, ArmorStandRenderState, ArmorStandArmorModel> {
    public static final Identifier DEFAULT_SKIN_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/armorstand/armorstand.png");
    ...
    public void extractRenderState(ArmorStand entity, ArmorStandRenderState state, float partialTicks) {
        ...
        HumanoidMobRenderer.extractHumanoidRenderState((LivingEntity)entity, state, partialTicks, this.itemModelResolver);
        state.yRot = Mth.rotLerp((float)partialTicks, (float)entity.yRotO, (float)entity.getYRot());
