...
extends AgeableMobRenderer<Strider, StriderRenderState, StriderModel> {
    private static final Identifier STRIDER_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/strider/strider.png");
    private static final Identifier STRIDER_BABY_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/strider/strider_baby.png");
    private static final Identifier COLD_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/strider/strider_cold.png");
    private static final Identifier COLD_BABY_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/strider/strider_cold_baby.png");
