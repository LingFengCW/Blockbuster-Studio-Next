...
extends MobRenderer<WitherBoss, WitherRenderState, WitherBossModel> {
    private static final Identifier WITHER_INVULNERABLE_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/wither/wither_invulnerable.png");
    private static final Identifier WITHER_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/wither/wither.png");
    ...
    public Identifier getTextureLocation(WitherRenderState state) {
        int invulnerableTicks = Mth.floor((float)state.invulnerableTicks);
