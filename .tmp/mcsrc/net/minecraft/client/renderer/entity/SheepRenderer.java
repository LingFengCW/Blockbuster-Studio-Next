...
extends AgeableMobRenderer<Sheep, SheepRenderState, SheepModel> {
    private static final Identifier SHEEP_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/sheep/sheep.png");
    private static final Identifier SHEEP_BABY_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/sheep/sheep_baby.png");
    ...
    public void extractRenderState(Sheep entity, SheepRenderState state, float partialTicks) {
        ...
        state.isJebSheep = SheepRenderer.checkMagicName((Entity)entity, "jeb_");
    }
}
