...
extends AgeableMobRenderer<Ocelot, FelineRenderState, AbstractFelineModel<FelineRenderState>> {
    private static final Identifier CAT_OCELOT_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/cat/ocelot.png");
    private static final Identifier CAT_OCELOT_BABY_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/cat/ocelot_baby.png");
