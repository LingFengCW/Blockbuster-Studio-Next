...
extends EntityRenderer<ExperienceOrb, ExperienceOrbRenderState> {
    private static final Identifier EXPERIENCE_ORB_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/experience/experience_orb.png");
    ...
    protected int getBlockLightLevel(ExperienceOrb entity, BlockPos blockPos) {
        return Mth.clamp((int)(super.getBlockLightLevel(entity, blockPos) + 7), (int)0, (int)15);
    }
