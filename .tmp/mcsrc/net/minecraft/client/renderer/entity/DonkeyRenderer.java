...
extends AbstractHorseRenderer<T, DonkeyRenderState, DonkeyModel> {
    ...
    public static enum Type {
        DONKEY(Identifier.withDefaultNamespace((String)"textures/entity/horse/donkey.png"), ModelLayers.DONKEY),
        DONKEY_BABY(Identifier.withDefaultNamespace((String)"textures/entity/horse/donkey_baby.png"), ModelLayers.DONKEY_BABY),
        MULE(Identifier.withDefaultNamespace((String)"textures/entity/horse/mule.png"), ModelLayers.MULE),
        MULE_BABY(Identifier.withDefaultNamespace((String)"textures/entity/horse/mule_baby.png"), ModelLayers.MULE_BABY);
