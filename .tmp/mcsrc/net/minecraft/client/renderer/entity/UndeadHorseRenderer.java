...
extends AbstractHorseRenderer<AbstractHorse, EquineRenderState, AbstractEquineModel<EquineRenderState>> {
    ...
    public static enum Type {
        SKELETON(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_skeleton.png"), ModelLayers.SKELETON_HORSE),
        SKELETON_BABY(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_skeleton_baby.png"), ModelLayers.SKELETON_HORSE_BABY),
        ZOMBIE(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_zombie.png"), ModelLayers.ZOMBIE_HORSE),
        ZOMBIE_BABY(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_zombie_baby.png"), ModelLayers.ZOMBIE_HORSE_BABY);
