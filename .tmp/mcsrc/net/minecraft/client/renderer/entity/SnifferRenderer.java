...
extends AgeableMobRenderer<Sniffer, SnifferRenderState, SnifferModel> {
    private static final Identifier SNIFFER_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/sniffer/sniffer.png");
    private static final Identifier SNIFFLET_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/sniffer/snifflet.png");
