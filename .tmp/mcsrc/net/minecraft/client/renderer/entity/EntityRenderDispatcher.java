...
implements ResourceManagerReloadListener {
    ...
    public <E extends Entity> int getPackedLightCoords(E entity, float partialTickTime) {
        return this.getRenderer((EntityRenderState)entity).getPackedLightCoords(entity, partialTickTime);
    }
    ...
    public <E extends Entity> boolean shouldRender(E entity, Frustum culler, double camX, double camY, double camZ) {
        EntityRenderer<?, E> renderer = this.getRenderer((EntityRenderState)entity);
    ...
    public <E extends Entity> EntityRenderState extractEntity(E entity, float partialTicks) {
        ...
        try {
            ...
            CrashReport report = CrashReport.forThrowable((Throwable)t, (String)"Extracting render state for an entity in world");
            ...
            rendererCategory.setDetail("Delta", (Object)Float.valueOf(partialTicks));
    ...
    public <S extends EntityRenderState> void submit(S renderState, CameraRenderState camera, double x, double y, double z, PoseStack poseStack, SubmitNodeCollector submitNodeCollector) {
        ...
        try {
            ...
            if (renderState.displayFireAnimation) {
                submitNodeCollector.submitFlame(poseStack, renderState, Mth.rotationAroundAxis((Vector3fc)Mth.Y_AXIS, (Quaternionf)camera.orientation, (Quaternionf)new Quaternionf()));
            }
            ...
            CrashReport report = CrashReport.forThrowable((Throwable)t, (String)"Rendering entity in world");
