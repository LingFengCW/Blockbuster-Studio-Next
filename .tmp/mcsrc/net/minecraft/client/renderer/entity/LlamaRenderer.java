...
extends AgeableMobRenderer<Llama, LlamaRenderState, LlamaModel> {
    private static final Map<Llama.Variant, Identifier> TEXTURES = Maps.newEnumMap(Map.of(Llama.Variant.CREAMY, Identifier.withDefaultNamespace((String)"textures/entity/llama/llama_creamy.png"), Llama.Variant.WHITE, Identifier.withDefaultNamespace((String)"textures/entity/llama/llama_white.png"), Llama.Variant.BROWN, Identifier.withDefaultNamespace((String)"textures/entity/llama/llama_brown.png"), Llama.Variant.GRAY, Identifier.withDefaultNamespace((String)"textures/entity/llama/llama_gray.png")));
    private static final Map<Llama.Variant, Identifier> BABY_TEXTURES = Maps.newEnumMap(Map.of(Llama.Variant.CREAMY, Identifier.withDefaultNamespace((String)"textures/entity/llama/llama_creamy_baby.png"), Llama.Variant.WHITE, Identifier.withDefaultNamespace((String)"textures/entity/llama/llama_white_baby.png"), Llama.Variant.BROWN, Identifier.withDefaultNamespace((String)"textures/entity/llama/llama_brown_baby.png"), Llama.Variant.GRAY, Identifier.withDefaultNamespace((String)"textures/entity/llama/llama_gray_baby.png")));
