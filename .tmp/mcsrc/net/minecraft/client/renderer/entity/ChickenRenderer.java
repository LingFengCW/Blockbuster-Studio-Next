 ...
 *  net.minecraft.world.entity.animal.chicken.ChickenVariant$ModelType
 */
...
extends MobRenderer<Chicken, ChickenRenderState, ChickenModel> {
    ...
    public void extractRenderState(Chicken entity, ChickenRenderState state, float partialTicks) {
        ...
        state.flap = Mth.lerp((float)partialTicks, (float)entity.oFlap, (float)entity.flap);
        state.flapSpeed = Mth.lerp((float)partialTicks, (float)entity.oFlapSpeed, (float)entity.flapSpeed);
