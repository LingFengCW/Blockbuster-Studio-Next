...
extends AgeableMobRenderer<PolarBear, PolarBearRenderState, PolarBearModel> {
    private static final Identifier BEAR_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/bear/polarbear.png");
    private static final Identifier BABY_BEAR_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/bear/polarbear_baby.png");
