...
extends MobRenderer<CopperGolem, CopperGolemRenderState, CopperGolemModel> {
    ...
    public Identifier getTextureLocation(CopperGolemRenderState state) {
        return CopperGolemOxidationLevels.getOxidationLevel((WeatheringCopper.WeatherState)state.weathering).texture();
    }

    private static Function<CopperGolemRenderState, Identifier> getEyeTextureLocationProvider() {
        return renderState -> CopperGolemOxidationLevels.getOxidationLevel((WeatheringCopper.WeatherState)renderState.weathering).eyeTexture();
    }
    ...
    public void extractRenderState(CopperGolem entity, CopperGolemRenderState state, float partialTicks) {
        ...
        if (item instanceof BlockItem) {
            ...
            BlockItemStateProperties blockItemState = (BlockItemStateProperties)antennaItem.getOrDefault(DataComponents.BLOCK_STATE, (Object)BlockItemStateProperties.EMPTY);
