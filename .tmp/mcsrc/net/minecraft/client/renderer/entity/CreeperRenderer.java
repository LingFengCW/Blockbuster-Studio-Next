...
extends MobRenderer<Creeper, CreeperRenderState, CreeperModel> {
    private static final Identifier CREEPER_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/creeper/creeper.png");
    ...
    protected float getWhiteOverlayProgress(CreeperRenderState state) {
        ...
        return Mth.clamp((float)step, (float)0.5f, (float)1.0f);
    }
