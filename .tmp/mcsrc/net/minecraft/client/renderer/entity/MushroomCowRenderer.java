...
extends AgeableMobRenderer<MushroomCow, MushroomCowRenderState, CowModel> {
    ...
    private static final Map<MushroomCow.Variant, MushroomCowTexture> TEXTURES = (Map)Util.make((Object)Maps.newHashMap(), map -> {
        map.put(MushroomCow.Variant.BROWN, new MushroomCowTexture(Identifier.withDefaultNamespace((String)"textures/entity/cow/mooshroom_brown.png"), Identifier.withDefaultNamespace((String)"textures/entity/cow/mooshroom_brown_baby.png")));
        map.put(MushroomCow.Variant.RED, new MushroomCowTexture(Identifier.withDefaultNamespace((String)"textures/entity/cow/mooshroom_red.png"), Identifier.withDefaultNamespace((String)"textures/entity/cow/mooshroom_red_baby.png")));
    });
