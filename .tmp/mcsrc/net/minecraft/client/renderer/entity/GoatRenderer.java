...
extends AgeableMobRenderer<Goat, GoatRenderState, GoatModel> {
    private static final Identifier GOAT_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/goat/goat.png");
    private static final Identifier BABY_GOAT_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/goat/goat_baby.png");
