...
extends AgeableMobRenderer<Axolotl, AxolotlRenderState, EntityModel<AxolotlRenderState>> {
    private static final Map<Axolotl.Variant, AxolotlTextures> TEXTURE_BY_TYPE = (Map)Util.make((Object)Maps.newHashMap(), map -> {
        for (Axolotl.Variant variant : Axolotl.Variant.values()) {
            AxolotlTextures textures = new AxolotlTextures(Identifier.withDefaultNamespace((String)String.format(Locale.ROOT, "textures/entity/axolotl/axolotl_%s.png", variant.getName())), Identifier.withDefaultNamespace((String)String.format(Locale.ROOT, "textures/entity/axolotl/axolotl_%s_baby.png", variant.getName())));
