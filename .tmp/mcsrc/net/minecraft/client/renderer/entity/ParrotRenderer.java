...
extends MobRenderer<Parrot, ParrotRenderState, ParrotModel> {
    private static final Identifier RED_BLUE = Identifier.withDefaultNamespace((String)"textures/entity/parrot/parrot_red_blue.png");
    private static final Identifier BLUE = Identifier.withDefaultNamespace((String)"textures/entity/parrot/parrot_blue.png");
    private static final Identifier GREEN = Identifier.withDefaultNamespace((String)"textures/entity/parrot/parrot_green.png");
    private static final Identifier YELLOW_BLUE = Identifier.withDefaultNamespace((String)"textures/entity/parrot/parrot_yellow_blue.png");
    private static final Identifier GREY = Identifier.withDefaultNamespace((String)"textures/entity/parrot/parrot_grey.png");
    ...
    public void extractRenderState(Parrot entity, ParrotRenderState state, float partialTicks) {
        ...
        float flap = Mth.lerp((float)partialTicks, (float)entity.oFlap, (float)entity.flap);
        float flapSpeed = Mth.lerp((float)partialTicks, (float)entity.oFlapSpeed, (float)entity.flapSpeed);
