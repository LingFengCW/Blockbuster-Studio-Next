...
extends AgeableMobRenderer<Armadillo, ArmadilloRenderState, ArmadilloModel> {
    private static final Identifier ARMADILLO_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/armadillo/armadillo.png");
    private static final Identifier ARMADILLO_BABY_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/armadillo/armadillo_baby.png");
