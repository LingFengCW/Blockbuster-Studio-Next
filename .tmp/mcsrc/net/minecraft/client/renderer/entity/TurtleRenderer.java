...
extends AgeableMobRenderer<Turtle, TurtleRenderState, TurtleModel> {
    private static final Identifier TURTLE_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/turtle/turtle.png");
    private static final Identifier BABY_TURTLE_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/turtle/turtle_baby.png");
