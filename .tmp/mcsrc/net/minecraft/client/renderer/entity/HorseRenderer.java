...
extends AbstractHorseRenderer<Horse, HorseRenderState, HorseModel> {
    private static final Map<Variant, HorseTextures> LOCATION_BY_VARIANT = Maps.newEnumMap(Map.of(Variant.WHITE, new HorseTextures(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_white.png"), Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_white_baby.png")), Variant.CREAMY, new HorseTextures(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_creamy.png"), Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_creamy_baby.png")), Variant.CHESTNUT, new HorseTextures(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_chestnut.png"), Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_chestnut_baby.png")), Variant.BROWN, new HorseTextures(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_brown.png"), Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_brown_baby.png")), Variant.BLACK, new HorseTextures(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_black.png"), Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_black_baby.png")), Variant.GRAY, new HorseTextures(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_gray.png"), Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_gray_baby.png")), Variant.DARK_BROWN, new HorseTextures(Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_darkbrown.png"), Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_darkbrown_baby.png"))));
