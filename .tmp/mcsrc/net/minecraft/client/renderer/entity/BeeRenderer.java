...
extends AgeableMobRenderer<Bee, BeeRenderState, BeeModel> {
    private static final Identifier ANGRY_BEE_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/bee/bee_angry.png");
    private static final Identifier ANGRY_NECTAR_BEE_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/bee/bee_angry_nectar.png");
    private static final Identifier BEE_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/bee/bee.png");
    private static final Identifier NECTAR_BEE_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/bee/bee_nectar.png");
    private static final Identifier ANGRY_BEE_BABY_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/bee/bee_angry_baby.png");
    private static final Identifier ANGRY_NECTAR_BEE_BABY_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/bee/bee_angry_nectar_baby.png");
    private static final Identifier BEE_BABY_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/bee/bee_baby.png");
    private static final Identifier NECTAR_BEE_BABY_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/bee/bee_nectar_baby.png");
