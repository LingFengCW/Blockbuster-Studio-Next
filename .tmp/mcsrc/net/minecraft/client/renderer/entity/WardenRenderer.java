...
extends MobRenderer<Warden, WardenRenderState, WardenModel> {
    private static final Identifier TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/warden/warden.png");
    private static final Identifier BIOLUMINESCENT_LAYER_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/warden/warden_bioluminescent_layer.png");
    private static final Identifier HEART_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/warden/warden_heart.png");
    private static final Identifier PULSATING_SPOTS_TEXTURE_1 = Identifier.withDefaultNamespace((String)"textures/entity/warden/warden_pulsating_spots_1.png");
    private static final Identifier PULSATING_SPOTS_TEXTURE_2 = Identifier.withDefaultNamespace((String)"textures/entity/warden/warden_pulsating_spots_2.png");
    ...
    public WardenRenderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new LivingEntityEmissiveLayer<WardenRenderState, WardenModel>(this, renderState -> PULSATING_SPOTS_TEXTURE_1, (warden, ageInTicks) -> Math.max(0.0f, Mth.cos((double)(ageInTicks * 0.045f)) * 0.25f), pulsatingSpotsModel, RenderTypes::entityTranslucentEmissive, false));
        this.addLayer(new LivingEntityEmissiveLayer<WardenRenderState, WardenModel>(this, renderState -> PULSATING_SPOTS_TEXTURE_2, (warden, ageInTicks) -> Math.max(0.0f, Mth.cos((double)(ageInTicks * 0.045f + (float)Math.PI)) * 0.25f), pulsatingSpotsModel, RenderTypes::entityTranslucentEmissive, false));
