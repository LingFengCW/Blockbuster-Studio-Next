...
extends AbstractSkeletonRenderer<Bogged, BoggedRenderState> {
    private static final Identifier BOGGED_SKELETON_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/skeleton/bogged.png");
    private static final Identifier BOGGED_OUTER_LAYER_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/skeleton/bogged_overlay.png");
