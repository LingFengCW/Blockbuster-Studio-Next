...
extends AgeableMobRenderer<Camel, CamelRenderState, CamelModel> {
    private static final Identifier CAMEL_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/camel/camel.png");
    private static final Identifier CAMEL_BABY_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/camel/camel_baby.png");
