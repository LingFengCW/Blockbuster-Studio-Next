...
extends RenderLayer<CatRenderState, AbstractFelineModel<CatRenderState>> {
    private static final Identifier CAT_COLLAR_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/cat/cat_collar.png");
    private static final Identifier CAT_BABY_COLLAR_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/cat/cat_collar_baby.png");
