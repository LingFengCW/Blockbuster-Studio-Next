...
extends RenderLayer<S, M> {
    ...
    private void renderArmorPiece(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, ItemStack itemStack, EquipmentSlot slot, int lightCoords, S state) {
        ...
        this.equipmentRenderer.renderLayers(layerType, (ResourceKey<EquipmentAsset>)((ResourceKey)equippable.assetId().orElseThrow()), model, state, itemStack, poseStack, submitNodeCollector, lightCoords, ((HumanoidRenderState)state).outlineColor);
    }
