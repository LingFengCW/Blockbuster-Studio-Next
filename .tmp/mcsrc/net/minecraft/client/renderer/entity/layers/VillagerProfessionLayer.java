...
extends RenderLayer<S, M> {
    private static final Int2ObjectMap<Identifier> LEVEL_LOCATIONS = (Int2ObjectMap)Util.make((Object)new Int2ObjectOpenHashMap(), map -> {
        map.put(1, (Object)Identifier.withDefaultNamespace((String)"stone"));
        map.put(2, (Object)Identifier.withDefaultNamespace((String)"iron"));
        map.put(3, (Object)Identifier.withDefaultNamespace((String)"gold"));
        map.put(4, (Object)Identifier.withDefaultNamespace((String)"emerald"));
        map.put(5, (Object)Identifier.withDefaultNamespace((String)"diamond"));
    });
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords, S state, float yRot, float xRot) {
        ...
        Holder type = villagerData.type();
        Holder profession = villagerData.profession();
        ...
        if (!profession.is(VillagerProfession.NONE) && !((LivingEntityRenderState)state).isBaby) {
            ...
            if (!profession.is(VillagerProfession.NITWIT)) {
                Identifier professionLevelTexture = this.getIdentifier("profession_level", (Identifier)LEVEL_LOCATIONS.get(Mth.clamp((int)villagerData.level(), (int)1, (int)LEVEL_LOCATIONS.size())));
    ...
    public <K> VillagerMetadataSection.Hat getHatData(Object2ObjectMap<ResourceKey<K>, VillagerMetadataSection.Hat> cache, String name, Holder<K> holder) {
        ...
        return (VillagerMetadataSection.Hat)((Object)cache.computeIfAbsent((Object)key, k -> this.resourceManager.getResource(this.getIdentifier(name, key.identifier())).flatMap(resource -> {
            try {
