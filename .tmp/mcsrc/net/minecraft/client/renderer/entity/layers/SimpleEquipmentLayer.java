...
extends RenderLayer<S, RM> {
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords, S state, float yRot, float xRot) {
        ...
        this.equipmentRenderer.renderLayers(this.layer, (ResourceKey<EquipmentAsset>)((ResourceKey)equippable.assetId().get()), model, state, equipment, poseStack, submitNodeCollector, lightCoords, (Identifier)null, ((LivingEntityRenderState)state).outlineColor, this.order);
    }
}
