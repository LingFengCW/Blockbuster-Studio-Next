...
extends RenderLayer<ZombieRenderState, DrownedModel> {
    private static final Identifier DROWNED_OUTER_LAYER_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/zombie/drowned_outer_layer.png");
    private static final Identifier BABY_DROWNED_OUTER_LAYER_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/zombie/drowned_outer_layer_baby.png");
