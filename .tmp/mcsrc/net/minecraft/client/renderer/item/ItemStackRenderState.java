 ...
 *  net.minecraft.world.phys.AABB$Builder
...
public class ItemStackRenderState {
    ...
    public AABB getModelBoundingBox() {
        ...
        this.visitExtents(arg_0 -> ((AABB.Builder)collector).include(arg_0));
        this.cachedModelBoundingBox = aabb = collector.isDefined() ? collector.build() : AABB.ofSize((Vec3)Vec3.ZERO, (double)0.0, (double)0.0, (double)0.0);
        return aabb;
    }
