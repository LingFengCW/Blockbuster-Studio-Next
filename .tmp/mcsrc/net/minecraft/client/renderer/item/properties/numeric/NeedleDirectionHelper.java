    ...
    public static Wobbler standardWobbler(final float factor) {
        return new Wobbler(){
            ...
            public void update(long tick, float targetRotation) {
                ...
                float tempDeltaRotation = Mth.positiveModulo((float)(targetRotation - this.rotation + 0.5f), (float)1.0f) - 0.5f;
                this.deltaRotation += tempDeltaRotation * 0.1f;
                this.deltaRotation *= factor;
                this.rotation = Mth.positiveModulo((float)(this.rotation + this.deltaRotation), (float)1.0f);
            }
        };
    }
