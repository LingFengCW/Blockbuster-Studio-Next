...
implements ItemModel {
    ...
    private static void validateAtlasUsage(List<BakedQuad> quads) {
        ...
        while (quadIterator.hasNext()) {
            ...
            if (quadAtlas.equals((Object)expectedAtlas)) continue;
        ...
        if (!expectedAtlas.equals((Object)TextureAtlas.LOCATION_ITEMS) && !expectedAtlas.equals((Object)TextureAtlas.LOCATION_BLOCKS)) {
    ...
    private static boolean hasSpecialAnimatedTexture(ItemStack itemStack) {
        return itemStack.is(ItemTags.COMPASSES) || itemStack.is((Object)Items.CLOCK);
    }
    ...
    public record Unbaked(Identifier model, Optional<Transformation> transformation, List<ItemTintSource> tints) implements ItemModel.Unbaked
    {
        ...
        public ItemModel bake(ItemModel.BakingContext context, Matrix4fc transformation) {
            ...
            Matrix4fc modelTransform = Transformation.compose((Matrix4fc)transformation, this.transformation);
