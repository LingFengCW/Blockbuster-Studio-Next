    ...
    public void buildVertices(VertexConsumer vertexConsumer) {
        ...
        for (int tileX = 0; tileX < width; tileX += this.tileWidth()) {
            ...
            if (this.tileWidth() <= remainingWidth) {
                ...
                u1 = Mth.lerp((float)((float)remainingWidth / (float)this.tileWidth()), (float)this.u0(), (float)this.u1());
            }
            for (int tileY = 0; tileY < height; tileY += this.tileHeight()) {
                ...
                if (this.tileHeight() <= remainingHeight) {
                    ...
                    v1 = Mth.lerp((float)((float)remainingHeight / (float)this.tileHeight()), (float)this.v0(), (float)this.v1());
                }
