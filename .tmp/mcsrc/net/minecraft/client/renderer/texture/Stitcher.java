...
public class Stitcher<T extends Entry> {
    ...
    public Stitcher(int maxWidth, int maxHeight, int mipLevel, int anisotropyBit) {
        ...
        this.padding = 1 << mipLevel << Mth.clamp((int)(anisotropyBit - 1), (int)0, (int)4);
    }
    ...
    private boolean expand(Holder<T> holder) {
        ...
        boolean yWillGrow;
        boolean yCanGrow;
        int xCurrentSize = Mth.smallestEncompassingPowerOfTwo((int)this.storageX);
        int yCurrentSize = Mth.smallestEncompassingPowerOfTwo((int)this.storageY);
        int xNewSize = Mth.smallestEncompassingPowerOfTwo((int)(this.storageX + holder.width));
        int yNewSize = Mth.smallestEncompassingPowerOfTwo((int)(this.storageY + holder.height));
