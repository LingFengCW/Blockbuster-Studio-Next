    ...
    implements SpriteSource.DiscardableLoader {
        ...
        public SpriteContents get(SpriteResourceLoader loader) {
            try {
                ...
                int x = Mth.floor((double)(this.region.x * xScale));
                int y = Mth.floor((double)(this.region.y * yScale));
                int width = Mth.floor((double)(this.region.width * xScale));
                int height = Mth.floor((double)(this.region.height * yScale));
