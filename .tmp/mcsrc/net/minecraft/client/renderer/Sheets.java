...
public class Sheets {
    public static final Identifier SHULKER_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/shulker_boxes.png");
    public static final Identifier BANNER_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/banner_patterns.png");
    public static final Identifier SHIELD_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/shield_patterns.png");
    public static final Identifier CHEST_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/chest.png");
    public static final Identifier ARMOR_TRIMS_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/armor_trims.png");
    ...
    public static final Identifier GUI_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/gui.png");
    public static final Identifier MAP_DECORATIONS_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/map_decorations.png");
    public static final Identifier PAINTINGS_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/paintings.png");
    public static final Identifier CELESTIAL_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/celestials.png");
    ...
    public static Identifier colorToShulkerSprite(DyeColor color) {
        return Identifier.withDefaultNamespace((String)("shulker_" + color.getName()));
    }
    ...
    public static SpriteId getBannerSprite(Holder<BannerPattern> pattern) {
        return BANNER_SPRITES.computeIfAbsent(((BannerPattern)pattern.value()).assetId(), BANNER_MAPPER::apply);
    }

    public static SpriteId getShieldSprite(Holder<BannerPattern> pattern) {
        return SHIELD_SPRITES.computeIfAbsent(((BannerPattern)pattern.value()).assetId(), SHIELD_MAPPER::apply);
    }
    ...
    public static SpriteId chooseSprite(ChestRenderState.ChestMaterialType materialType, ChestType type) {
        return switch (materialType) {
            ...
            case ChestRenderState.ChestMaterialType.COPPER_UNAFFECTED -> (SpriteId)((MultiblockChestResources)CHEST_COPPER.unaffected()).select(type);
            case ChestRenderState.ChestMaterialType.COPPER_EXPOSED -> (SpriteId)((MultiblockChestResources)CHEST_COPPER.exposed()).select(type);
            case ChestRenderState.ChestMaterialType.COPPER_WEATHERED -> (SpriteId)((MultiblockChestResources)CHEST_COPPER.weathered()).select(type);
            case ChestRenderState.ChestMaterialType.COPPER_OXIDIZED -> (SpriteId)((MultiblockChestResources)CHEST_COPPER.oxidized()).select(type);
        };
    }
}
