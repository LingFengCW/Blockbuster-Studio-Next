...
public class Octree {
    ...
    public Octree(SectionPos cameraSection, int renderDistance, int sectionsPerChunk, int minBlockY) {
        ...
        int boundingBoxSizeInSections = Mth.smallestEncompassingPowerOfTwo((int)visibleAreaDiameterInSections);
    ...
    implements Node {
        ...
        public boolean add(SectionRenderDispatcher.RenderSection section) {
            ...
            boolean sectionXDiffNegative = SectionPos.sectionToBlockCoord((int)SectionPos.x((long)sectionNode)) - this.bbCenterX < 0;
            boolean sectionYDiffNegative = SectionPos.sectionToBlockCoord((int)SectionPos.y((long)sectionNode)) - this.bbCenterY < 0;
            boolean sectionZDiffNegative = SectionPos.sectionToBlockCoord((int)SectionPos.z((long)sectionNode)) - this.bbCenterZ < 0;
