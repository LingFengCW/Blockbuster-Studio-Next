...
extends HumanoidModel<T> {
    ...
    public void setupAnim(T state) {
        ...
        float max = 0.4f;
        this.rightArm.xRot = Mth.clamp((float)this.rightArm.xRot, (float)-0.4f, (float)0.4f);
        this.leftArm.xRot = Mth.clamp((float)this.leftArm.xRot, (float)-0.4f, (float)0.4f);
        this.rightLeg.xRot = Mth.clamp((float)this.rightLeg.xRot, (float)-0.4f, (float)0.4f);
        this.leftLeg.xRot = Mth.clamp((float)this.leftLeg.xRot, (float)-0.4f, (float)0.4f);
