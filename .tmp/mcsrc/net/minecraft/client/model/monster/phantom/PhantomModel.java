...
extends EntityModel<PhantomRenderState> {
    ...
    public void setupAnim(PhantomRenderState state) {
        ...
        this.leftWingBase.zRot = Mth.cos((double)anim) * 16.0f * ((float)Math.PI / 180);
        this.leftWingTip.zRot = Mth.cos((double)anim) * 16.0f * ((float)Math.PI / 180);
        this.rightWingBase.zRot = -this.leftWingBase.zRot;
        this.rightWingTip.zRot = -this.leftWingTip.zRot;
        this.tailBase.xRot = -(5.0f + Mth.cos((double)(anim * 2.0f)) * 5.0f) * ((float)Math.PI / 180);
        this.tailTip.xRot = -(5.0f + Mth.cos((double)(anim * 2.0f)) * 5.0f) * ((float)Math.PI / 180);
    }
}
