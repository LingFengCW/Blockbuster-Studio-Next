...
HeadedModel {
    ...
    public void setupAnim(S state) {
        ...
        if (pose == AbstractIllager.IllagerArmPose.ATTACKING) {
            ...
            this.leftArm.z = 0.0f;
            this.leftArm.x = 5.0f;
            this.rightArm.xRot = Mth.cos((double)(((IllagerRenderState)state).ageInTicks * 0.6662f)) * 0.25f;
            this.leftArm.xRot = Mth.cos((double)(((IllagerRenderState)state).ageInTicks * 0.6662f)) * 0.25f;
            ...
            this.rightArm.z = 0.0f;
            this.rightArm.x = -5.0f;
            this.rightArm.xRot = Mth.cos((double)(((IllagerRenderState)state).ageInTicks * 0.6662f)) * 0.05f;
            this.rightArm.zRot = 2.670354f;
            this.rightArm.yRot = 0.0f;
            this.leftArm.z = 0.0f;
            this.leftArm.x = 5.0f;
            this.leftArm.xRot = Mth.cos((double)(((IllagerRenderState)state).ageInTicks * 0.6662f)) * 0.05f;
            this.leftArm.zRot = -2.3561945f;
            this.leftArm.yRot = 0.0f;
        }
