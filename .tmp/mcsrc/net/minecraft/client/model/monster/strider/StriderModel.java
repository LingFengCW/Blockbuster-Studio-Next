...
extends EntityModel<StriderRenderState> {
    ...
    public void animateBristle(float ageInTicks, float bristleFlow, ModelPart firstBristle, ModelPart secondBristle, ModelPart thirdBristle, BiConsumer<ModelPart, Float> addRotationFunction) {
        ...
        addRotationFunction.accept(firstBristle, Float.valueOf(0.1f * Mth.sin((double)(ageInTicks * 0.4f))));
        addRotationFunction.accept(secondBristle, Float.valueOf(0.1f * Mth.sin((double)(ageInTicks * 0.2f))));
        addRotationFunction.accept(thirdBristle, Float.valueOf(0.05f * Mth.sin((double)(ageInTicks * -0.4f))));
    }
}
