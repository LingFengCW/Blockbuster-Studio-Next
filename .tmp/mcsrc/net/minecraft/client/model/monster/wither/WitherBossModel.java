...
extends EntityModel<WitherRenderState> {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation g) {
        ...
        root.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(12, 22).addBox(0.0f, 0.0f, 0.0f, 3.0f, 6.0f, 3.0f, g), PartPose.offsetAndRotation(-2.0f, 6.9f + Mth.cos((double)0.2042035162448883) * 10.0f, -0.5f + Mth.sin((double)0.2042035162448883) * 10.0f, 0.83252203f, 0.0f, 0.0f));
