...
implements ArmedModel<VexRenderState> {
    ...
    public void setupAnim(VexRenderState state) {
        ...
        float movingArmZBob = Mth.cos((double)(state.ageInTicks * 5.5f * ((float)Math.PI / 180))) * 0.1f;
        ...
        this.leftWing.yRot = 1.0995574f + Mth.cos((double)(state.ageInTicks * 45.836624f * ((float)Math.PI / 180))) * ((float)Math.PI / 180) * 16.2f;
