...
VillagerLikeModel<WitchRenderState> {
    ...
    public void setupAnim(WitchRenderState state) {
        ...
        this.nose.xRot = Mth.sin((double)(state.ageInTicks * speed)) * 4.5f * ((float)Math.PI / 180);
        this.nose.zRot = Mth.cos((double)(state.ageInTicks * speed)) * 2.5f * ((float)Math.PI / 180);
