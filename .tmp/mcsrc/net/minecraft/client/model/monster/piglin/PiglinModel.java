...
extends AbstractPiglinModel<PiglinRenderState> {
    ...
    public void setupAnim(PiglinRenderState state) {
        ...
        if (pose == PiglinArmPose.DANCING) {
            ...
            this.rightEar.zRot = 0.5235988f + (float)Math.PI / 180 * Mth.sin((double)(dancePos * 30.0f)) * 10.0f;
            this.leftEar.zRot = -0.5235988f - (float)Math.PI / 180 * Mth.cos((double)(dancePos * 30.0f)) * 10.0f;
            this.head.x += Mth.sin((double)(dancePos * 10.0f));
            this.head.y += Mth.sin((double)(dancePos * 40.0f)) + 0.4f;
            this.rightArm.zRot = (float)Math.PI / 180 * (70.0f + Mth.cos((double)(dancePos * 40.0f)) * 10.0f);
            this.leftArm.zRot = this.rightArm.zRot * -1.0f;
            this.rightArm.y += Mth.sin((double)(dancePos * 40.0f)) * 0.5f - 0.5f;
            this.leftArm.y += Mth.sin((double)(dancePos * 40.0f)) * 0.5f + 0.5f;
            this.body.y += Mth.sin((double)(dancePos * 40.0f)) * 0.35f;
