...
HeadedModel {
    ...
    public void setupAnim(T state) {
        ...
        if (fallFlying) {
            ...
            this.head.xRot = Mth.rotLerpRad((float)swimAmount, (float)this.head.xRot, (float)-0.7853982f);
        }
        ...
        this.rightArm.xRot = Mth.cos((double)(animationPos * 0.6662f + (float)Math.PI)) * 2.0f * animationSpeed * 0.5f / ((HumanoidRenderState)state).speedValue;
        this.leftArm.xRot = Mth.cos((double)(animationPos * 0.6662f)) * 2.0f * animationSpeed * 0.5f / ((HumanoidRenderState)state).speedValue;
        this.rightLeg.xRot = Mth.cos((double)(animationPos * 0.6662f)) * 1.4f * animationSpeed / ((HumanoidRenderState)state).speedValue;
        this.leftLeg.xRot = Mth.cos((double)(animationPos * 0.6662f + (float)Math.PI)) * 1.4f * animationSpeed / ((HumanoidRenderState)state).speedValue;
        ...
        if (swimAmount > 0.0f) {
            ...
            if (!((HumanoidRenderState)state).isUsingItem) {
                if (swimPos < 14.0f) {
                    this.leftArm.xRot = Mth.rotLerpRad((float)leftArmSwimAmount, (float)this.leftArm.xRot, (float)0.0f);
                    this.rightArm.xRot = Mth.lerp((float)rightArmSwimAmount, (float)this.rightArm.xRot, (float)0.0f);
                    this.leftArm.yRot = Mth.rotLerpRad((float)leftArmSwimAmount, (float)this.leftArm.yRot, (float)((float)Math.PI));
                    this.rightArm.yRot = Mth.lerp((float)rightArmSwimAmount, (float)this.rightArm.yRot, (float)((float)Math.PI));
                    this.leftArm.zRot = Mth.rotLerpRad((float)leftArmSwimAmount, (float)this.leftArm.zRot, (float)((float)Math.PI + 1.8707964f * this.quadraticArmUpdate(swimPos) / this.quadraticArmUpdate(14.0f)));
                    this.rightArm.zRot = Mth.lerp((float)rightArmSwimAmount, (float)this.rightArm.zRot, (float)((float)Math.PI - 1.8707964f * this.quadraticArmUpdate(swimPos) / this.quadraticArmUpdate(14.0f)));
                } else if (swimPos >= 14.0f && swimPos < 22.0f) {
                    internalSwimPos = (swimPos - 14.0f) / 8.0f;
                    this.leftArm.xRot = Mth.rotLerpRad((float)leftArmSwimAmount, (float)this.leftArm.xRot, (float)(1.5707964f * internalSwimPos));
                    this.rightArm.xRot = Mth.lerp((float)rightArmSwimAmount, (float)this.rightArm.xRot, (float)(1.5707964f * internalSwimPos));
                    this.leftArm.yRot = Mth.rotLerpRad((float)leftArmSwimAmount, (float)this.leftArm.yRot, (float)((float)Math.PI));
                    this.rightArm.yRot = Mth.lerp((float)rightArmSwimAmount, (float)this.rightArm.yRot, (float)((float)Math.PI));
                    this.leftArm.zRot = Mth.rotLerpRad((float)leftArmSwimAmount, (float)this.leftArm.zRot, (float)(5.012389f - 1.8707964f * internalSwimPos));
                    this.rightArm.zRot = Mth.lerp((float)rightArmSwimAmount, (float)this.rightArm.zRot, (float)(1.2707963f + 1.8707964f * internalSwimPos));
                } else if (swimPos >= 22.0f && swimPos < 26.0f) {
                    internalSwimPos = (swimPos - 22.0f) / 4.0f;
                    this.leftArm.xRot = Mth.rotLerpRad((float)leftArmSwimAmount, (float)this.leftArm.xRot, (float)(1.5707964f - 1.5707964f * internalSwimPos));
                    this.rightArm.xRot = Mth.lerp((float)rightArmSwimAmount, (float)this.rightArm.xRot, (float)(1.5707964f - 1.5707964f * internalSwimPos));
                    this.leftArm.yRot = Mth.rotLerpRad((float)leftArmSwimAmount, (float)this.leftArm.yRot, (float)((float)Math.PI));
                    this.rightArm.yRot = Mth.lerp((float)rightArmSwimAmount, (float)this.rightArm.yRot, (float)((float)Math.PI));
                    this.leftArm.zRot = Mth.rotLerpRad((float)leftArmSwimAmount, (float)this.leftArm.zRot, (float)((float)Math.PI));
                    this.rightArm.zRot = Mth.lerp((float)rightArmSwimAmount, (float)this.rightArm.zRot, (float)((float)Math.PI));
                }
            }
            float amplitude = 0.3f;
            float slowdown = 0.33333334f;
            this.leftLeg.xRot = Mth.lerp((float)swimAmount, (float)this.leftLeg.xRot, (float)(0.3f * Mth.cos((double)(animationPos * 0.33333334f + (float)Math.PI))));
            this.rightLeg.xRot = Mth.lerp((float)swimAmount, (float)this.rightLeg.xRot, (float)(0.3f * Mth.cos((double)(animationPos * 0.33333334f))));
        }
    }
    ...
    private void poseRightArm(T state) {
        switch (((HumanoidRenderState)state).rightArmPose.ordinal()) {
            ...
            case 7: {
                this.rightArm.xRot = Mth.clamp((float)(this.head.xRot - 1.9198622f - (((HumanoidRenderState)state).isCrouching ? 0.2617994f : 0.0f)), (float)-2.4f, (float)3.3f);
    ...
    private void poseLeftArm(T state) {
        switch (((HumanoidRenderState)state).leftArmPose.ordinal()) {
            ...
            case 7: {
                this.leftArm.xRot = Mth.clamp((float)(this.head.xRot - 1.9198622f - (((HumanoidRenderState)state).isCrouching ? 0.2617994f : 0.0f)), (float)-2.4f, (float)3.3f);
    ...
    private void poseBlockingArm(ModelPart arm, boolean right) {
        arm.xRot = arm.xRot * 0.5f - 0.9424779f + Mth.clamp((float)this.head.xRot, (float)-1.3962634f, (float)0.43633232f);
        arm.yRot = (right ? -30.0f : 30.0f) * ((float)Math.PI / 180) + Mth.clamp((float)this.head.yRot, (float)-0.5235988f, (float)0.5235988f);
    }
    ...
    protected void setupAttackAnimation(T state) {
        ...
        this.body.yRot = Mth.sin((double)(Mth.sqrt((float)attackTime) * ((float)Math.PI * 2))) * 0.2f;
        ...
        switch (((HumanoidRenderState)state).swingAnimationType) {
            case WHACK: {
                float swing = Ease.outQuart((float)attackTime);
