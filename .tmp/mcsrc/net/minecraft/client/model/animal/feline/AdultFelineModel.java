...
extends AbstractFelineModel<T> {
    ...
    public void setupAnim(T state) {
        ...
        if (((FelineRenderState)state).lieDownAmount > 0.0f) {
            this.head.zRot = Mth.rotLerp((float)((FelineRenderState)state).lieDownAmount, (float)this.head.zRot, (float)-1.2707963f);
            this.head.yRot = Mth.rotLerp((float)((FelineRenderState)state).lieDownAmount, (float)this.head.yRot, (float)1.2707963f);
            ...
            this.tail1.xRot = Mth.rotLerp((float)((FelineRenderState)state).lieDownAmountTail, (float)this.tail1.xRot, (float)0.8f);
            this.tail2.xRot = Mth.rotLerp((float)((FelineRenderState)state).lieDownAmountTail, (float)this.tail2.xRot, (float)-0.4f);
        }
