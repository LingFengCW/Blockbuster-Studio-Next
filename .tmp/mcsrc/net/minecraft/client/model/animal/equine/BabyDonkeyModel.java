...
extends DonkeyModel {
    ...
    protected void offsetLegPositionWhenStanding(float standing) {
        this.leftHindLeg.y = Mth.lerp((float)standing, (float)this.leftHindLeg.y, (float)-0.3f);
        this.rightHindLeg.y = Mth.lerp((float)standing, (float)this.leftHindLeg.y, (float)-0.3f);
    }
    ...
    protected void animateHeadPartsPlacement(float eating, float standing) {
        this.headParts.y = Mth.lerp((float)eating, (float)this.headParts.y, (float)-1.2f);
        this.headParts.z = Mth.lerp((float)standing, (float)this.headParts.z, (float)-3.6f);
    }
}
