...
extends EntityModel<BoatRenderState> {
    ...
    private static void animatePaddle(float time, int side, ModelPart paddle) {
        paddle.xRot = Mth.clampedLerp((float)((Mth.sin((double)(-time)) + 1.0f) / 2.0f), (float)-1.0471976f, (float)-0.2617994f);
        paddle.yRot = Mth.clampedLerp((float)((Mth.sin((double)(-time + 1.0f)) + 1.0f) / 2.0f), (float)-0.7853982f, (float)0.7853982f);
        if (side == 1) {
