...
extends SingleQuadParticle {
    ...
    private DragonBreathParticle(ClientLevel level, double x, double y, double z, double xa, double ya, double za, SpriteSet sprites) {
        ...
        this.yd = ya;
        this.zd = za;
        this.rCol = Mth.nextFloat((RandomSource)this.random, (float)0.7176471f, (float)0.8745098f);
        this.gCol = Mth.nextFloat((RandomSource)this.random, (float)0.0f, (float)0.0f);
        this.bCol = Mth.nextFloat((RandomSource)this.random, (float)0.8235294f, (float)0.9764706f);
        this.quadSize *= 0.75f;
    ...
    public float getQuadSize(float a) {
        return this.quadSize * Mth.clamp((float)(((float)this.age + a) / (float)this.lifetime * 32.0f), (float)0.0f, (float)1.0f);
    }
