...
extends SingleQuadParticle {
    ...
    public float getQuadSize(float a) {
        return this.quadSize * Mth.clamp((float)(((float)this.age + a) / (float)this.lifetime * 0.75f), (float)0.0f, (float)1.0f);
    }
    ...
    public void extract(QuadParticleRenderState particleTypeRenderState, Camera camera, float partialTickTime) {
        ...
        this.alpha = 1.0f - Mth.clamp((float)(((float)this.age + partialTickTime) / (float)this.lifetime), (float)0.0f, (float)1.0f);
