...
implements AutoCloseable {
    ...
    protected void apply(Map<String, List<Notification>> preparations, ResourceManager manager, ProfilerFiller profiler) {
        ...
        if (notifications.stream().anyMatch(n -> n.period == 0L)) {
            Util.logAndPauseIfInIde((String)("A periodic notification in " + String.valueOf(this.notifications) + " has a period of zero minutes"));
            this.stopTimer();
            return;
        }
    ...
    extends TimerTask {
        ...
        public void run() {
            ...
            for (Notification notification : this.notifications) {
                ...
                this.minecraft.execute(() -> SystemToast.add(Minecraft.getInstance().gui.toastManager(), SystemToast.SystemToastId.PERIODIC_NOTIFICATION, (Component)Component.translatable((String)notification.title, (Object[])new Object[]{elapsedPeriods}), (Component)Component.translatable((String)notification.message, (Object[])new Object[]{elapsedPeriods})));
                return;
            }
        }
    }
