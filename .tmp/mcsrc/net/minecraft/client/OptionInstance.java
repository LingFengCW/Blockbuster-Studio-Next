...
public final class OptionInstance<T> {
    ...
    public OptionInstance(String captionId, TooltipSupplier<T> tooltip, CaptionBasedToString<T> toString, ValueSet<T> values, Codec<T> codec, T initialValue, ValueUpdateListener<? super T> onValueUpdate) {
        this.caption = Component.translatable((String)captionId);
    ...
    public record SliderableEnum<T>(List<T> values, Codec<T> codec) implements SliderableValueSet<T>
    {
        ...
        public double toSliderValue(T value) {
            ...
            return Mth.map((double)this.values.indexOf(value), (double)0.0, (double)(this.values.size() - 1), (double)0.0, (double)1.0);
        }

        @Override
        public Optional<T> next(T current) {
            int currentIntex = this.values.indexOf(current);
            int nextIndex = Mth.clamp((int)(currentIntex + 1), (int)0, (int)(this.values.size() - 1));
        ...
        public Optional<T> previous(T current) {
            int currentIntex = this.values.indexOf(current);
            int previousIndex = Mth.clamp((int)(currentIntex - 1), (int)0, (int)(this.values.size() - 1));
        ...
        public T fromSliderValue(double slider) {
            ...
            int index = Mth.floor((double)Mth.map((double)slider, (double)0.0, (double)1.0, (double)0.0, (double)this.values.size()));
            return this.values.get(Mth.clamp((int)index, (int)0, (int)(this.values.size() - 1)));
        }
    ...
    extends SliderableValueSet<Integer> {
        ...
        default public double toSliderValue(Integer value) {
            ...
            return Mth.map((double)((double)value.intValue() + 0.5), (double)this.minInclusive(), (double)((double)this.maxInclusive() + 1.0), (double)0.0, (double)1.0);
        }
        ...
        default public Integer fromSliderValue(double slider) {
            ...
            return Mth.floor((double)Mth.map((double)slider, (double)0.0, (double)1.0, (double)this.minInclusive(), (double)((double)this.maxInclusive() + 1.0)));
        }
