...
public enum NarratorStatus {
    ...
    private NarratorStatus(int id, String key) {
        this.id = id;
        this.name = Component.translatable((String)key);
    }
    ...
    static {
        BY_ID = ByIdMap.continuous(NarratorStatus::getId, (Object[])NarratorStatus.values(), (ByIdMap.OutOfBoundsStrategy)ByIdMap.OutOfBoundsStrategy.WRAP);
