...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            CrashReport report2 = CrashReport.forThrowable((Throwable)t, (String)"Loading native libraries");
            CrashReportCategory initialization = report2.addCategory("Initialization");
            NativeModuleLister.addCrashSection((CrashReportCategory)initialization);
        ...
        try {
            ...
            CompletableFuture dataFixerOptimization = DataFixers.optimize((Set)DataFixTypes.TYPES_FOR_LEVEL_LIST);
            CrashReport.preload();
            ...
            PreferredGraphicsApi forcedGraphicsApi = (PreferredGraphicsApi)((Object)Main.parseArgument(optionSet, graphicsBackendOption));
            ...
            UUID uuid = Main.hasValidUuid((OptionSpec<String>)uuidOption, optionSet, logger) ? UndashedUuid.fromStringLenient((String)((String)uuidOption.value(optionSet))) : UUIDUtil.createOfflinePlayerUUID((String)((String)usernameOption.value(optionSet)));
            ...
            CrashReport report3 = CrashReport.forThrowable((Throwable)t, (String)stage);
        ...
        shutdownThread.setUncaughtExceptionHandler((Thread.UncaughtExceptionHandler)new DefaultUncaughtExceptionHandler(logger));
        ...
        try {
            ...
            report = CrashReport.forThrowable((Throwable)t, (String)"Initializing game");
        ...
        try {
            ...
            report = CrashReport.forThrowable((Throwable)t, (String)"Game shutdown");
    ...
    private static GameConfig.QuickPlayVariant getQuickPlayVariant(OptionSet optionSet, OptionSpec<String> quickPlaySingleplayerOption, OptionSpec<String> quickPlayMultiplayerOption, OptionSpec<String> quickPlayRealmsOption) {
        ...
        if (optionSet.has(quickPlayMultiplayerOption)) {
            ...
            return (GameConfig.QuickPlayVariant)Optionull.mapOrDefault((Object)serverAddress, GameConfig.QuickPlayMultiplayerData::new, (Object)GameConfig.QuickPlayVariant.DISABLED);
        }
        if (optionSet.has(quickPlayRealmsOption)) {
            ...
            return (GameConfig.QuickPlayVariant)Optionull.mapOrDefault((Object)realmId, GameConfig.QuickPlayRealmsData::new, (Object)GameConfig.QuickPlayVariant.DISABLED);
        }
        return GameConfig.QuickPlayVariant.DISABLED;
    }
