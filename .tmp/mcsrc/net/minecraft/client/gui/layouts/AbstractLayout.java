...
implements Layout {
    ...
    protected static abstract class AbstractChildWrapper {
        ...
        public void setX(int x, int availableSpace) {
            ...
            int offset = (int)Mth.lerp((float)this.layoutSettings.xAlignment, (float)leastOffset, (float)mostOffset);
        ...
        public void setY(int y, int availableSpace) {
            ...
            int offset = Math.round(Mth.lerp((float)this.layoutSettings.yAlignment, (float)leastOffset, (float)mostOffset));
