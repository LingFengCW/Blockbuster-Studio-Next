...
implements Layout {
    ...
    public <T extends LayoutElement> T addChild(T child, Consumer<LayoutSettings> layoutSettingsAdjustments) {
        return this.orientation.addChild(this.wrapped, child, this.nextChildIndex++, (LayoutSettings)Util.make((Object)this.newCellSettings(), layoutSettingsAdjustments));
    }
