...
public class MultilineTextField {
    ...
    public void insertText(String input) {
        ...
        String text = this.truncateInsertionText(StringUtil.filterText((String)input, (boolean)true));
    ...
    public void deleteText(int dir) {
        if (!this.hasSelection()) {
            this.selectCursor = Mth.clamp((int)(this.cursor + dir), (int)0, (int)this.value.length());
        }
        this.insertText("");
    }
    ...
    public StringView getLineView(int lineIndex) {
        return this.displayLines.get(Mth.clamp((int)lineIndex, (int)0, (int)(this.displayLines.size() - 1)));
    }
    ...
    public void seekCursorToPoint(double x, double y) {
        int left = Mth.floor((double)x);
        int top = Mth.floor((double)(y / (double)this.font.lineHeight));
        StringView lineView = this.displayLines.get(Mth.clamp((int)top, (int)0, (int)(this.displayLines.size() - 1)));
    ...
    private StringView getCursorLineView(int lineOffset) {
        ...
        return this.displayLines.get(Mth.clamp((int)(lineIndex + lineOffset), (int)0, (int)(this.displayLines.size() - 1)));
    }
    ...
    public StringView getPreviousWord() {
        ...
        for (startPosition = Mth.clamp((int)this.cursor, (int)0, (int)(this.value.length() - 1)); startPosition > 0 && Character.isWhitespace(this.value.charAt(startPosition - 1)); --startPosition) {
        }
    ...
    public StringView getNextWord() {
        ...
        for (startPosition = Mth.clamp((int)this.cursor, (int)0, (int)(this.value.length() - 1)); startPosition < this.value.length() && !Character.isWhitespace(this.value.charAt(startPosition)); ++startPosition) {
        }
    ...
    private String truncateFullText(String input) {
        if (this.hasCharacterLimit()) {
            return StringUtil.truncateStringIfNecessary((String)input, (int)this.characterLimit, (boolean)false);
        }
        return input;
    }
    ...
    private String truncateInsertionText(String input) {
        ...
        if (this.hasCharacterLimit()) {
            ...
            truncatedInput = StringUtil.truncateStringIfNecessary((String)input, (int)remainingCharacters, (boolean)false);
        }
        return truncatedInput;
    }

    private boolean overflowsLineLimit(String newValue) {
        return this.hasLineLimit() && this.font.getSplitter().splitLines(newValue, this.width, Style.EMPTY).size() + (StringUtil.endsWithNewLine((String)newValue) ? 1 : 0) > this.lineLimit;
    }
