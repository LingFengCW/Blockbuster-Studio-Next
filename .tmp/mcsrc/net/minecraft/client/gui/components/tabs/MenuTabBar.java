...
extends TabNavigationBar {
    ...
    public void arrangeElements(int width) {
        ...
        int tabWidth = Mth.roundToward((int)(tabsWidth / this.tabs.size()), (int)2);
        for (TabButton button : this.tabButtons) {
            button.setWidth(tabWidth);
        }
        this.layout.arrangeElements();
        this.layout.setX(Mth.roundToward((int)((width - tabsWidth) / 2), (int)2));
        this.layout.setY(0);
    }
    ...
    extends TabButton {
        private static final WidgetSprites SPRITES = new WidgetSprites(Identifier.withDefaultNamespace((String)"widget/tab_selected"), Identifier.withDefaultNamespace((String)"widget/tab"), Identifier.withDefaultNamespace((String)"widget/tab_selected_highlighted"), Identifier.withDefaultNamespace((String)"widget/tab_highlighted"));
