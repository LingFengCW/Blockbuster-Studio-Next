...
extends AbstractTextAreaWidget {
    ...
    private static final int PLACEHOLDER_TEXT_COLOR = ARGB.color((int)204, (int)-2039584);
    ...
    public void updateWidgetNarration(NarrationElementOutput output) {
        output.add(NarratedElementType.TITLE, (Component)Component.translatable((String)"gui.narrate.editBox", (Object[])new Object[]{this.getMessage(), this.getValue()}));
    }
    ...
    protected void extractContents(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (value.isEmpty() && !this.isFocused()) {
            graphics.textWithWordWrap(this.font, (FormattedText)this.placeholder, this.getInnerLeft(), this.getInnerTop(), this.width - this.totalInnerPadding(), PLACEHOLDER_TEXT_COLOR);
            return;
        }
    ...
    protected void extractDecorations(GuiGraphicsExtractor graphics) {
        ...
        if (this.textField.hasCharacterLimit()) {
            ...
            MutableComponent countText = Component.translatable((String)"gui.multiLineEditBox.character_limit", (Object[])new Object[]{this.textField.value().length(), characterLimit});
            graphics.text(this.font, (Component)countText, this.getX() + this.width - this.font.width((FormattedText)countText), this.getY() + this.height + 4, -6250336);
        }
    }
