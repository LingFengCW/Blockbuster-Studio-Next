...
public class ProfilerPieChart {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics) {
        ...
        List list = this.profilerPieChartResults.getTimes(this.profilerTreePath);
        ...
        String currentNodeName = ProfileResults.demanglePath((String)currentNode.name);
    ...
    public void profilerPieChartKeyPress(int key) {
        ...
        } else if (--key < list.size() && !"unspecified".equals(((ResultField)list.get((int)key)).name)) {
            if (!this.profilerTreePath.isEmpty()) {
                this.profilerTreePath = this.profilerTreePath + "\u001e";
            }
            this.profilerTreePath = this.profilerTreePath + ((ResultField)list.get((int)key)).name;
        }
    }
}
