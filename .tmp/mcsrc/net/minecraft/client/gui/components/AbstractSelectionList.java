...
extends AbstractContainerWidget {
    private static final Identifier MENU_LIST_BACKGROUND = Identifier.withDefaultNamespace((String)"textures/gui/menu_list_background.png");
    ...
    protected void enableScissor(GuiGraphicsExtractor graphics) {
        graphics.enableScissor(Mth.clamp((int)this.getX(), (int)0, (int)graphics.guiWidth()), Mth.clamp((int)this.getY(), (int)0, (int)graphics.guiHeight()), Mth.clamp((int)this.getRight(), (int)0, (int)graphics.guiWidth()), Mth.clamp((int)this.getBottom(), (int)0, (int)graphics.guiHeight()));
    }
    ...
    protected void narrateListElementPosition(NarrationElementOutput output, E element) {
        ...
        if (children.size() > 1 && (index = children.indexOf(element)) != -1) {
            output.add(NarratedElementType.POSITION, (Component)Component.translatable((String)"narrator.position.list", (Object[])new Object[]{index + 1, children.size()}));
        }
    }
