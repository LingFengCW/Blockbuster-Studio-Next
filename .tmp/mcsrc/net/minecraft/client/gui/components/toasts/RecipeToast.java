...
implements Toast {
    ...
    private static final Component TITLE_TEXT = Component.translatable((String)"recipe.toast.title");
    private static final Component DESCRIPTION_TEXT = Component.translatable((String)"recipe.toast.description");
    ...
    public static void addOrUpdate(ToastManager toastManager, RecipeDisplay recipe) {
        ...
        ContextMap context = SlotDisplayContext.fromLevel((Level)toastManager.getMinecraft().level);
