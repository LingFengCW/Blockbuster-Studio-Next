...
implements Toast {
    private static final Identifier NOW_PLAYING_BACKGROUND_SPRITE = Identifier.withDefaultNamespace((String)"toast/now_playing");
    private static final Identifier MUSIC_NOTES_SPRITE = Identifier.parse((String)"icon/music_notes");
    ...
    private static Component getNowPlayingString(@Nullable String currentSongKey) {
        ...
        return Component.translatable((String)currentSongKey.replace("/", "."));
    }
    ...
    private static int getWidth(@Nullable String currentSong, Font font) {
        return 30 + font.width((FormattedText)NowPlayingToast.getNowPlayingString(currentSong)) + 7;
    }
