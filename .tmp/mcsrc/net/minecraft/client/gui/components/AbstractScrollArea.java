...
extends AbstractWidget {
    ...
    private static final Identifier SCROLLER_SPRITE = Identifier.withDefaultNamespace((String)"widget/scroller");
    private static final Identifier SCROLLER_BACKGROUND_SPRITE = Identifier.withDefaultNamespace((String)"widget/scroller_background");
    ...
    public void setScrollAmount(double scrollAmount) {
        this.scrollAmount = Mth.clamp((double)scrollAmount, (double)0.0, (double)this.maxScrollAmount());
    }
    ...
    protected int scrollerHeight() {
        return Mth.clamp((int)((int)((float)(this.height * this.height) / (float)this.contentHeight())), (int)32, (int)(this.height - 8));
    }
