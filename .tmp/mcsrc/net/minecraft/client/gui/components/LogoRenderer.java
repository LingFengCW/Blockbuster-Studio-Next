...
public class LogoRenderer {
    public static final Identifier MINECRAFT_LOGO = Identifier.withDefaultNamespace((String)"textures/gui/title/minecraft.png");
    public static final Identifier EASTER_EGG_LOGO = Identifier.withDefaultNamespace((String)"textures/gui/title/minceraft.png");
    public static final Identifier MINECRAFT_EDITION = Identifier.withDefaultNamespace((String)"textures/gui/title/edition.png");
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int width, float alpha, int heightOffset) {
        ...
        int color = ARGB.white((float)effectiveAlpha);
