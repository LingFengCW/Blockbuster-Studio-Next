...
implements Renderable {
    private static final Identifier BACKGROUND = Identifier.withDefaultNamespace((String)"widget/preedit");
    private static final Style FOCUSED_STYLE = Style.EMPTY.withUnderlined(Boolean.valueOf(true));
