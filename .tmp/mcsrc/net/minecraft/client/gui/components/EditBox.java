...
extends AbstractWidget {
    private static final WidgetSprites SPRITES = new WidgetSprites(Identifier.withDefaultNamespace((String)"widget/text_field"), Identifier.withDefaultNamespace((String)"widget/text_field_highlighted"));
    ...
    protected MutableComponent createNarrationMessage() {
        ...
        return Component.translatable((String)"gui.narrate.editBox", (Object[])new Object[]{message, this.value});
    }
    ...
    public void insertText(String input) {
        ...
        String text = StringUtil.filterText((String)input);
    ...
    private int getCursorPos(int dir) {
        return Util.offsetByCodepoints((String)this.value, (int)this.cursorPos, (int)dir);
    }
    ...
    private int findClickedPositionInText(MouseButtonEvent event) {
        int positionInText = Math.min(Mth.floor((double)event.x()) - this.textX, this.getInnerWidth());
    ...
    public void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        int relHighlightPos = Mth.clamp((int)(this.highlightPos - this.displayPos), (int)0, (int)displayed.length());
    ...
    public void setHighlightPos(int pos) {
        this.highlightPos = Mth.clamp((int)pos, (int)0, (int)this.value.length());
    ...
    public void setHint(Component hint) {
        boolean hasNoStyle = hint.getStyle().equals((Object)Style.EMPTY);
