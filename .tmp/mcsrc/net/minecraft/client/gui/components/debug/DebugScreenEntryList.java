...
public class DebugScreenEntryList {
    ...
    public void load() {
        try {
            ...
            Dynamic data = new Dynamic((DynamicOps)JsonOps.INSTANCE, (Object)StrictJsonParser.parse((String)FileUtils.readFileToString((File)this.debugProfileFile, (Charset)StandardCharsets.UTF_8)));
    ...
    private void resetToProfile(DebugScreenProfile profile) {
        ...
        this.resetStatuses(DebugScreenEntries.PROFILES.get((Object)profile));
    }
    ...
    private record SerializedOptions(Optional<DebugScreenProfile> profile, Optional<Map<Identifier, DebugScreenEntryStatus>> custom) {
        private static final Codec<Map<Identifier, DebugScreenEntryStatus>> CUSTOM_ENTRIES_CODEC = Codec.unboundedMap((Codec)Identifier.CODEC, DebugScreenEntryStatus.CODEC);
