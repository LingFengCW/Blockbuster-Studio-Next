...
extends Screen {
    private static final Component TITLE = Component.translatable((String)"gui.socialInteractions.title");
    private static final Identifier BACKGROUND_SPRITE = Identifier.withDefaultNamespace((String)"social_interactions/background");
    private static final Identifier SEARCH_SPRITE = Identifier.withDefaultNamespace((String)"icon/search");
    private static final Component TAB_ALL = Component.translatable((String)"gui.socialInteractions.tab_all");
    private static final Component TAB_HIDDEN = Component.translatable((String)"gui.socialInteractions.tab_hidden");
    private static final Component TAB_BLOCKED = Component.translatable((String)"gui.socialInteractions.tab_blocked");
    ...
    private static final Component SEARCH_HINT = Component.translatable((String)"gui.socialInteractions.search_hint").withStyle(EditBox.SEARCH_HINT_STYLE);
    private static final Component EMPTY_SEARCH = Component.translatable((String)"gui.socialInteractions.search_empty").withStyle(ChatFormatting.GRAY);
    private static final Component EMPTY_HIDDEN = Component.translatable((String)"gui.socialInteractions.empty_hidden").withStyle(ChatFormatting.GRAY);
    private static final Component EMPTY_BLOCKED = Component.translatable((String)"gui.socialInteractions.empty_blocked").withStyle(ChatFormatting.GRAY);
    private static final Component BLOCKING_HINT = Component.translatable((String)"gui.socialInteractions.blocking_hint");
    ...
    public Component getNarrationMessage() {
        if (this.serverLabel != null) {
            return CommonComponents.joinForNarration((Component[])new Component[]{super.getNarrationMessage(), this.serverLabel});
        }
    ...
    private void updateServerLabel(Minecraft minecraft) {
        ...
        if (this.playerCount != playerCount) {
            ...
            this.serverLabel = playerCount > 1 ? Component.translatable((String)"gui.socialInteractions.server_label.multiple", (Object[])new Object[]{serverName, playerCount}) : Component.translatable((String)"gui.socialInteractions.server_label.single", (Object[])new Object[]{serverName, playerCount});
