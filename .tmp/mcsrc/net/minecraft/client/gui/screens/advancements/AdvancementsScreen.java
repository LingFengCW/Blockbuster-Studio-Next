...
implements ClientAdvancements.Listener {
    private static final Identifier WINDOW_LOCATION = Identifier.withDefaultNamespace((String)"textures/gui/advancements/window.png");
    ...
    public void removed() {
        ...
        if (connection != null) {
            connection.send((Packet<?>)ServerboundSeenAdvancementsPacket.closedScreen());
        }
    }
