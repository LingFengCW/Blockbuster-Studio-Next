...
extends Screen {
    ...
    public DatapackLoadFailureScreen(Runnable cancelCallback, Runnable safeModeCallback) {
        super((Component)Component.translatable((String)"datapackFailure.title"));
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder((Component)Component.translatable((String)"datapackFailure.safeMode"), button -> this.safeModeCallback.run()).bounds(this.width / 2 - 155, this.height / 6 + 96, 150, 20).build());
