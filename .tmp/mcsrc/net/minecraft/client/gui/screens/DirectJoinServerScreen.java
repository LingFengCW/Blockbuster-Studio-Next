...
extends Screen {
    private static final Component ENTER_IP_LABEL = Component.translatable((String)"manageServer.enterIp");
    ...
    public DirectJoinServerScreen(Screen lastScreen, BooleanConsumer callback, ServerData serverData) {
        super((Component)Component.translatable((String)"selectServer.direct"));
    ...
    protected void init() {
        ...
        this.selectButton = this.addRenderableWidget(Button.builder((Component)Component.translatable((String)"selectServer.select"), button -> this.onSelect()).bounds(this.width / 2 - 100, this.height / 4 + 96 + 12, 200, 20).build());
