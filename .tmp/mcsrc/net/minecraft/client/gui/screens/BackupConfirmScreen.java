...
extends Screen {
    private static final Component SKIP_AND_JOIN = Component.translatable((String)"selectWorld.backupJoinSkipButton");
    public static final Component BACKUP_AND_JOIN = Component.translatable((String)"selectWorld.backupJoinConfirmButton");
    ...
    protected void init() {
        ...
        this.eraseCache = Checkbox.builder((Component)Component.translatable((String)"selectWorld.backupEraseCache").withColor(-2039584), this.font).pos(this.width / 2 - 155 + 80, 76 + textSize).build();
