...
extends Screen {
    ...
    public DeathScreen(@Nullable Component causeOfDeath, boolean hardcore, LocalPlayer player) {
        super((Component)Component.translatable((String)(hardcore ? "deathScreen.title.hardcore" : "deathScreen.title")));
        this.causeOfDeath = causeOfDeath;
        this.hardcore = hardcore;
        this.player = player;
        MutableComponent scoreValue = Component.literal((String)Integer.toString(player.getScore())).withStyle(ChatFormatting.YELLOW);
        this.deathScore = Component.translatable((String)"deathScreen.score.value", (Object[])new Object[]{scoreValue});
    }
    ...
    protected void init() {
        ...
        MutableComponent message = this.hardcore ? Component.translatable((String)"deathScreen.spectate") : Component.translatable((String)"deathScreen.respawn");
        this.exitButtons.add(this.addRenderableWidget(Button.builder((Component)message, button -> {
            this.player.respawn();
            button.active = false;
        }).bounds(this.width / 2 - 100, this.height / 4 + 72, 200, 20).build()));
        this.exitToTitleButton = this.addRenderableWidget(Button.builder((Component)Component.translatable((String)"deathScreen.titleScreen"), button -> this.minecraft.getReportingContext().draftReportHandled(this.minecraft, this, this::handleExitToTitleScreen, true)).bounds(this.width / 2 - 100, this.height / 4 + 96, 200, 20).build());
    ...
    private void handleExitToTitleScreen() {
        ...
        }, (Component)Component.translatable((String)"deathScreen.quit.confirm"), CommonComponents.EMPTY, (Component)Component.translatable((String)"deathScreen.titleScreen"), (Component)Component.translatable((String)"deathScreen.respawn"));
