...
implements AutoCloseable {
    private static final Identifier MISSING_LOCATION = Identifier.withDefaultNamespace((String)"textures/misc/unknown_server.png");
    ...
    public static FaviconTexture forWorld(TextureManager textureManager, String levelId) {
        return new FaviconTexture(textureManager, Identifier.withDefaultNamespace((String)("worlds/" + Util.sanitizeName((String)levelId, Identifier::validPathChar) + "/" + String.valueOf(Hashing.sha1().hashUnencodedChars((CharSequence)levelId)) + "/icon")));
    }

    public static FaviconTexture forServer(TextureManager textureManager, String address) {
        return new FaviconTexture(textureManager, Identifier.withDefaultNamespace((String)("servers/" + String.valueOf(Hashing.sha1().hashUnencodedChars((CharSequence)address)) + "/icon")));
    }
