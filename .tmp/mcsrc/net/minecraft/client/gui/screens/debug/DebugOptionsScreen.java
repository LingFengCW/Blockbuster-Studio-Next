...
extends Screen {
    private static final Component TITLE = Component.translatable((String)"debug.options.title");
    private static final Component SUBTITLE = Component.translatable((String)"debug.options.warning").withColor(-2142128);
    private static final Component ENABLED_TEXT = Component.translatable((String)"debug.entry.always");
    private static final Component IN_OVERLAY_TEXT = Component.translatable((String)"debug.entry.overlay");
    private static final Component DISABLED_TEXT = CommonComponents.OPTION_OFF;
    private static final Component NOT_ALLOWED_TOOLTIP = Component.translatable((String)"debug.options.notAllowed.tooltip");
    private static final Component SEARCH = Component.translatable((String)"debug.options.search").withStyle(EditBox.SEARCH_HINT_STYLE);
    ...
    private void addProfileButton(DebugScreenProfile profile, LinearLayout bottomButtons) {
        Button profileButton = Button.builder((Component)Component.translatable((String)profile.translationKey()), button -> {
    ...
    extends AbstractOptionEntry {
        ...
        public OptionEntry(DebugOptionsScreen debugOptionsScreen, Identifier location) {
            ...
            this.always = CycleButton.booleanBuilder((Component)ENABLED_TEXT.copy().withColor(-2142128), (Component)ENABLED_TEXT.copy().withColor(-4539718), false).displayOnlyValue().withCustomNarration(this::narrateButton).create(10, 5, 60, 16, (Component)Component.literal((String)name), (button, newValue) -> this.setValue(location, DebugScreenEntryStatus.ALWAYS_ON));
            this.overlay = CycleButton.booleanBuilder((Component)IN_OVERLAY_TEXT.copy().withColor(-171), (Component)IN_OVERLAY_TEXT.copy().withColor(-4539718), false).displayOnlyValue().withCustomNarration(this::narrateButton).create(10, 5, 60, 16, (Component)Component.literal((String)name), (button, newValue) -> this.setValue(location, DebugScreenEntryStatus.IN_OVERLAY));
            this.never = CycleButton.booleanBuilder((Component)DISABLED_TEXT.copy().withColor(-1), (Component)DISABLED_TEXT.copy().withColor(-4539718), false).displayOnlyValue().withCustomNarration(this::narrateButton).create(10, 5, 60, 16, (Component)Component.literal((String)name), (button, newValue) -> this.setValue(location, DebugScreenEntryStatus.NEVER));
        ...
        private MutableComponent narrateButton(CycleButton<Boolean> booleanCycleButton) {
            ...
            MutableComponent current = Component.translatable((String)("debug.entry.currently." + status.getSerializedName()), (Object[])new Object[]{this.name});
            return CommonComponents.optionNameValue((Component)current, (Component)booleanCycleButton.getMessage());
        }
