...
extends ConfirmScreen {
    private static final Component WARNING_TEXT = Component.translatable((String)"chat.link.warning").withColor(-13108);
    private static final int BUTTON_WIDTH = 100;
    private final String url;
    private final boolean showWarning;

    public ConfirmLinkScreen(BooleanConsumer callback, String url, boolean trusted) {
        this(callback, (Component)ConfirmLinkScreen.confirmMessage(trusted), (Component)Component.literal((String)url), url, trusted ? CommonComponents.GUI_CANCEL : CommonComponents.GUI_NO, trusted);
    }
    ...
    protected static MutableComponent confirmMessage(boolean trusted, String url) {
        return ConfirmLinkScreen.confirmMessage(trusted).append(CommonComponents.SPACE).append((Component)Component.literal((String)url));
    }

    protected static MutableComponent confirmMessage(boolean trusted) {
        return Component.translatable((String)(trusted ? "chat.link.confirmTrusted" : "chat.link.confirm"));
    }
