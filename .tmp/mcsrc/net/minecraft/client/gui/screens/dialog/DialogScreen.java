 ...
 *  net.minecraft.server.dialog.DialogAction
 *  net.minecraft.server.dialog.Input
 *  net.minecraft.server.dialog.body.DialogBody
...
extends Screen {
    public static final Component DISCONNECT = Component.translatable((String)"menu.custom_screen_info.disconnect");
    private static final int WARNING_BUTTON_SIZE = 20;
    private static final WidgetSprites WARNING_BUTTON_SPRITES = new WidgetSprites(Identifier.withDefaultNamespace((String)"dialog/warning_button"), Identifier.withDefaultNamespace((String)"dialog/warning_button_disabled"), Identifier.withDefaultNamespace((String)"dialog/warning_button_highlighted"));
    ...
    private Button createWarningButton() {
        ImageButton result = new ImageButton(0, 0, 20, 20, WARNING_BUTTON_SPRITES, button -> this.minecraft.gui.setScreen(WarningScreen.create(this.minecraft, this.connectionAccess, this)), (Component)Component.translatable((String)"menu.custom_screen_info.button_narration"));
        result.setTooltip(Tooltip.create((Component)Component.translatable((String)"menu.custom_screen_info.tooltip")));
        return result;
    }
        ...
        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{ClickEvent.RunCommand.class, ClickEvent.ShowDialog.class, ClickEvent.Custom.class}, (ClickEvent)clickEvent2, n)) {
            case 0: {
                ...
                try {
                    ...
                    this.connectionAccess.runCommand(Commands.trimOptionalPrefix((String)command), activeScreen);
                    return;
                }
            ...
            case 1: {
                ...
                this.connectionAccess.openDialog((Holder<Dialog>)dialog.dialog(), activeScreen);
                return;
            }
            case 2: {
    ...
    extends ConfirmScreen {
        ...
        private WarningScreen(Minecraft minecraft, DialogConnectionAccess connectionAccess, MutableObject<Screen> returnScreen) {
            ...
            }, (Component)Component.translatable((String)"menu.custom_screen_info.title"), (Component)Component.translatable((String)"menu.custom_screen_info.contents"), CommonComponents.disconnectButtonLabel((boolean)minecraft.isLocalServer()), CommonComponents.GUI_BACK);
