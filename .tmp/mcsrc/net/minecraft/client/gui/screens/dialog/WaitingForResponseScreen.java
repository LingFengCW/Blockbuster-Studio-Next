...
extends Screen {
    private static final Component TITLE = Component.translatable((String)"gui.waitingForResponse.title");
    private static final Component[] BUTTON_LABELS = new Component[]{Component.empty(), Component.translatable((String)"gui.waitingForResponse.button.inactive", (Object[])new Object[]{4}), Component.translatable((String)"gui.waitingForResponse.button.inactive", (Object[])new Object[]{3}), Component.translatable((String)"gui.waitingForResponse.button.inactive", (Object[])new Object[]{2}), Component.translatable((String)"gui.waitingForResponse.button.inactive", (Object[])new Object[]{1}), CommonComponents.GUI_BACK};
