...
extends Screen {
    private static final Component NAME_LABEL = Component.translatable((String)"manageServer.enterName");
    private static final Component IP_LABEL = Component.translatable((String)"manageServer.enterIp");
    private static final Component DEFAULT_SERVER_NAME = Component.translatable((String)"selectServer.defaultName");
    ...
    protected void init() {
        ...
        this.addRenderableWidget(CycleButton.builder(ServerData.ServerPackStatus::getName, this.serverData.getResourcePackStatus()).withValues((ServerData.ServerPackStatus[])ServerData.ServerPackStatus.values()).create(this.width / 2 - 100, this.height / 4 + 72, 200, 20, (Component)Component.translatable((String)"manageServer.resourcePack"), (button, value) -> this.serverData.setResourcePackStatus((ServerData.ServerPackStatus)((Object)value))));
