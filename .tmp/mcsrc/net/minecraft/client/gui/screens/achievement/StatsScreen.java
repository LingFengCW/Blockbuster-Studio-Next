...
extends Screen {
    ...
    private static final Identifier HEADER_SPRITE = Identifier.withDefaultNamespace((String)"statistics/header");
    private static final Identifier SORT_UP_SPRITE = Identifier.withDefaultNamespace((String)"statistics/sort_up");
    private static final Identifier SORT_DOWN_SPRITE = Identifier.withDefaultNamespace((String)"statistics/sort_down");
    private static final Component PENDING_TEXT = Component.translatable((String)"multiplayer.downloadingStats");
    private static final Component NO_VALUE_DISPLAY = Component.translatable((String)"stats.none");
    ...
    private void setTabActiveStateAndTooltip(int index) {
        ...
        if (active) {
            ...
            this.tabNavigationBar.setTabTooltip(index, Tooltip.create((Component)Component.translatable((String)"gui.stats.none_found")));
        }
    }
    ...
    extends ObjectSelectionList<Entry> {
        ...
        public GeneralStatisticsList(StatsScreen statsScreen, Minecraft minecraft) {
            ...
            stats.sort(Comparator.comparing(k -> I18n.get(StatsScreen.getTranslationKey((Stat<Identifier>)k), new Object[0])));
            for (Stat stat : stats) {
                this.addEntry(new Entry(this, (Stat<Identifier>)stat));
            }
        }
        ...
        public ItemStatisticsList(StatsScreen statsScreen, Minecraft minecraft) {
            ...
            for (Item item : BuiltInRegistries.ITEM) {
                ...
                for (StatType<Item> statType : this.itemColumns) {
                    if (!statType.contains((Object)item) || statsScreen.stats.getValue(statType.get((Object)item)) <= 0) continue;
                    addToList = true;
                }
            ...
            for (Block block : BuiltInRegistries.BLOCK) {
                ...
                for (StatType<Item> statType : this.blockColumns) {
                    if (!statType.contains((Object)block) || statsScreen.stats.getValue(statType.get((Object)block)) <= 0) continue;
                    addToList = true;
                }
                if (!addToList) continue;
            ...
            public int compare(ItemRow one, ItemRow two) {
                ...
                if (this.this$1.sortColumn == null) {
                    ...
                    if (item1 instanceof BlockItem) {
                        ...
                        v0 = this.this$1.this$0.stats.getValue(type, (Object)blockItem.getBlock());
                    } else {
                        v0 = key1 = -1;
                    }
                    if (item2 instanceof BlockItem) {
                        blockItem = (BlockItem)item2;
                        n = this.this$1.this$0.stats.getValue(type, (Object)blockItem.getBlock());
                    } else {
                        n = -1;
                    }
                    key2 = n;
                    ...
                    StatType<?> type = this.this$1.sortColumn;
                    key1 = this.this$1.this$0.stats.getValue(type, (Object)item1);
                    key2 = this.this$1.this$0.stats.getValue(type, (Object)item2);
                }
                if (key1 == key2) {
                    return this.this$1.sortOrder * Integer.compare(Item.getId((Item)item1), Item.getId((Item)item2));
                }
            ...
            public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
                ...
                for (col = 0; col < itemStatsList.blockColumns.size(); ++col) {
                    ...
                    if (item instanceof BlockItem) {
                        ...
                        stat = itemStatsList.blockColumns.get(col).get((Object)blockItem.getBlock());
                    } else {
                        stat = null;
                    }
                ...
                for (col = 0; col < itemStatsList.itemColumns.size(); ++col) {
                    this.extractStat(graphics, itemStatsList.itemColumns.get(col).get((Object)this.item), this.getContentX() + this.this$1.getColumnX(col + itemStatsList.blockColumns.size()), this.getContentYMiddle() - ((StatsScreen)this.this$1.this$0).font.lineHeight / 2, index % 2 == 0);
                }
            }

            protected void extractStat(GuiGraphicsExtractor graphics, @Nullable Stat<?> stat, int x, int y, boolean shaded) {
                Component msg = stat == null ? NO_VALUE_DISPLAY : Component.literal((String)stat.format(this.this$1.this$0.stats.getValue(stat)));
                graphics.text(this.this$1.this$0.font, msg, x - this.this$1.this$0.font.width((FormattedText)msg), y, shaded ? -1 : -4539718);
            }
    ...
    extends ObjectSelectionList<MobRow> {
        ...
        public MobsStatisticsList(StatsScreen statsScreen, Minecraft minecraft) {
            ...
            for (EntityType type : BuiltInRegistries.ENTITY_TYPE) {
                if (statsScreen.stats.getValue(Stats.ENTITY_KILLED.get((Object)type)) <= 0 && statsScreen.stats.getValue(Stats.ENTITY_KILLED_BY.get((Object)type)) <= 0) continue;
                this.addEntry(new MobRow(this, type));
            }
        }
        ...
        extends ObjectSelectionList.Entry<MobRow> {
            ...
            public MobRow(MobsStatisticsList mobsStatisticsList, EntityType<?> type) {
                ...
                if (kills == 0) {
                    ...
                    this.kills = Component.translatable((String)"stat_type.minecraft.killed", (Object[])new Object[]{kills, this.mobName});
                    this.hasKills = true;
                }
                ...
                if (killedBy == 0) {
                    ...
                    this.killedBy = Component.translatable((String)"stat_type.minecraft.killed_by", (Object[])new Object[]{this.mobName, killedBy});
