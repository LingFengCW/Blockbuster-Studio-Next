...
extends AbstractWidget {
    private static final Identifier SLOT_MANY_CRAFTABLE_SPRITE = Identifier.withDefaultNamespace((String)"recipe_book/slot_many_craftable");
    private static final Identifier SLOT_CRAFTABLE_SPRITE = Identifier.withDefaultNamespace((String)"recipe_book/slot_craftable");
    private static final Identifier SLOT_MANY_UNCRAFTABLE_SPRITE = Identifier.withDefaultNamespace((String)"recipe_book/slot_many_uncraftable");
    private static final Identifier SLOT_UNCRAFTABLE_SPRITE = Identifier.withDefaultNamespace((String)"recipe_book/slot_uncraftable");
    ...
    private static boolean allRecipesHaveSameResultDisplay(List<ResolvedEntry> entries) {
        ...
        while (itemsIterator.hasNext()) {
            ...
            if (ItemStack.isSameItemSameComponents((ItemStack)firstItem, (ItemStack)nextItem)) continue;
            return false;
        }
        return true;
    }
    ...
    public void updateWidgetNarration(NarrationElementOutput output) {
        output.add(NarratedElementType.TITLE, (Component)Component.translatable((String)"narration.recipe", (Object[])new Object[]{this.getDisplayStack().getHoverName()}));
        if (this.hasMultipleRecipes()) {
