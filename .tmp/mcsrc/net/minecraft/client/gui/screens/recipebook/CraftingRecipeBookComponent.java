...
extends RecipeBookComponent<AbstractCraftingMenu> {
    private static final WidgetSprites FILTER_BUTTON_SPRITES = new WidgetSprites(Identifier.withDefaultNamespace((String)"recipe_book/filter_enabled"), Identifier.withDefaultNamespace((String)"recipe_book/filter_disabled"), Identifier.withDefaultNamespace((String)"recipe_book/filter_enabled_highlighted"), Identifier.withDefaultNamespace((String)"recipe_book/filter_disabled_highlighted"));
    ...
    protected void fillGhostRecipe(GhostSlots ghostSlots, RecipeDisplay recipe, ContextMap context) {
        ...
        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{ShapedCraftingRecipeDisplay.class, ShapelessCraftingRecipeDisplay.class}, (RecipeDisplay)recipeDisplay2, n)) {
            case 0: {
                ShapedCraftingRecipeDisplay shaped = (ShapedCraftingRecipeDisplay)recipeDisplay2;
                List inputSlots = ((AbstractCraftingMenu)this.menu).getInputGridSlots();
                PlaceRecipeHelper.placeRecipe((int)((AbstractCraftingMenu)this.menu).getGridWidth(), (int)((AbstractCraftingMenu)this.menu).getGridHeight(), (int)shaped.width(), (int)shaped.height(), (Iterable)shaped.ingredients(), (ingredient, gridIndex, gridXPos, gridYPos) -> {
