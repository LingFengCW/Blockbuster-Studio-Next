...
public class RecipeBookPage {
    ...
    private static final WidgetSprites PAGE_FORWARD_SPRITES = new WidgetSprites(Identifier.withDefaultNamespace((String)"recipe_book/page_forward"), Identifier.withDefaultNamespace((String)"recipe_book/page_forward_highlighted"));
    private static final WidgetSprites PAGE_BACKWARD_SPRITES = new WidgetSprites(Identifier.withDefaultNamespace((String)"recipe_book/page_backward"), Identifier.withDefaultNamespace((String)"recipe_book/page_backward_highlighted"));
    private static final Component NEXT_PAGE_TEXT = Component.translatable((String)"gui.recipebook.next_page");
    private static final Component PREVIOUS_PAGE_TEXT = Component.translatable((String)"gui.recipebook.previous_page");
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int xo, int yo, int mouseX, int mouseY, float a) {
        if (this.totalPages > 1) {
            MutableComponent pageNumbers = Component.translatable((String)"gui.recipebook.page", (Object[])new Object[]{this.currentPage + 1, this.totalPages});
