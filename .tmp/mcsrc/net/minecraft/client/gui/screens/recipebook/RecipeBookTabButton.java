...
extends ImageButton {
    private static final WidgetSprites SPRITES = new WidgetSprites(Identifier.withDefaultNamespace((String)"recipe_book/tab"), Identifier.withDefaultNamespace((String)"recipe_book/tab_selected"));
