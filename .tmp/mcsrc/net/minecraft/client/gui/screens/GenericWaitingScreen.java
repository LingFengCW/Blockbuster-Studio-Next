...
extends Screen {
    ...
    public static GenericWaitingScreen createWaitingWithoutButton(Component title, Component messageText) {
        return new GenericWaitingScreen(title, true, messageText, (Component)Component.empty(), () -> {}, 0, false, false);
    }

    public static GenericWaitingScreen createWaiting(Component title, Component buttonLabel, Runnable buttonCallback) {
        return new GenericWaitingScreen(title, true, (Component)Component.empty(), buttonLabel, buttonCallback, 0, true, false);
    }
    ...
    public Component getNarrationMessage() {
        return CommonComponents.joinForNarration((Component[])new Component[]{this.title, this.messageText});
    }
}
