...
extends Screen {
    private static final Component DOWNLOADING_TERRAIN_TEXT = Component.translatable((String)"multiplayer.downloadingTerrain");
    private static final Component READY_TO_PLAY_TEXT = Component.translatable((String)"narrator.ready_to_play");
    ...
    private static final Object2IntMap<ChunkStatus> COLORS = (Object2IntMap)Util.make((Object)new Object2IntOpenHashMap(), map -> {
    ...
    protected void updateNarratedWidget(NarrationElementOutput output) {
        if (this.loadTracker.hasProgress()) {
            output.add(NarratedElementType.TITLE, (Component)Component.translatable((String)"loading.progress", (Object[])new Object[]{Mth.floor((float)(this.loadTracker.serverProgress() * 100.0f))}));
        }
    }
    ...
    public static void extractChunksForRendering(GuiGraphicsExtractor graphics, int xCenter, int yCenter, int size, int margin, ChunkLoadStatusView statusView) {
        ...
        for (int x = 0; x < diameter; ++x) {
            for (int z = 0; z < diameter; ++z) {
                ...
                graphics.fill(xCellStart, yCellStart, xCellStart + size, yCellStart + size, ARGB.opaque((int)COLORS.getInt((Object)status)));
            }
        }
    }
