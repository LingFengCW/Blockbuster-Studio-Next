...
extends Screen {
    private static final Component SYMLINK_WORLD_TITLE = Component.translatable((String)"symlink_warning.title.world").withStyle(ChatFormatting.BOLD);
    private static final Component SYMLINK_WORLD_MESSAGE_TEXT = Component.translatable((String)"symlink_warning.message.world", (Object[])new Object[]{Component.translationArg((URI)CommonLinks.SYMLINK_HELP)});
    private static final Component SYMLINK_PACK_TITLE = Component.translatable((String)"symlink_warning.title.pack").withStyle(ChatFormatting.BOLD);
    private static final Component SYMLINK_PACK_MESSAGE_TEXT = Component.translatable((String)"symlink_warning.message.pack", (Object[])new Object[]{Component.translationArg((URI)CommonLinks.SYMLINK_HELP)});
