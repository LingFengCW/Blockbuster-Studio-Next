...
extends Screen {
    ...
    public static final Component ABORT_CONNECTION = Component.translatable((String)"connect.aborted");
    public static final Component UNKNOWN_HOST_MESSAGE = Component.translatable((String)"disconnect.genericReason", (Object[])new Object[]{Component.translatable((String)"disconnect.unknownHost")});
    ...
    public static void startConnecting(Screen parent, Minecraft minecraft, ServerAddress hostAndPort, ServerData data, boolean isQuickPlay, @Nullable TransferState transferState) {
        ...
        if (transferState != null) {
            screen.updateStatus((Component)Component.translatable((String)"connect.transferring"));
        }
            ...
            public void run() {
                ...
                try {
                    ...
                    synchronized (connectScreen) {
                        ...
                        this.this$0.channelFuture = Connection.connect((InetSocketAddress)address, (EventLoopGroupHolder)EventLoopGroupHolder.remote((boolean)minecraft.options.useNativeTransport()), (Connection)pendingConnection);
                    }
                    ...
                    this.this$0.connection.initiateServerboundPlayConnection(address.getHostName(), address.getPort(), LoginProtocols.SERVERBOUND, LoginProtocols.CLIENTBOUND, (ClientboundPacketListener)new ClientHandshakePacketListenerImpl(this.this$0.connection, minecraft, server, this.this$0.parent, false, null, this.this$0::updateStatus, new LevelLoadTracker(), transferState), transferState != null);
                    this.this$0.connection.send((Packet)new ServerboundHelloPacket(minecraft.getUser().getName(), minecraft.getUser().getProfileId()));
                }
                    ...
                    minecraft.execute(() -> minecraft2.gui.setScreen(new DisconnectedScreen(this.this$0.parent, this.this$0.connectFailedTitle, (Component)Component.translatable((String)"disconnect.genericReason", (Object[])new Object[]{message}))));
                }
            }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (current - this.lastNarration > 2000L) {
            ...
            this.minecraft.getNarrator().saySystemNow((Component)Component.translatable((String)"narrator.joining"));
        }
