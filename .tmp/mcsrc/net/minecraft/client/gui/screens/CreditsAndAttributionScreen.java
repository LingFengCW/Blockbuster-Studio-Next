...
extends Screen {
    ...
    private static final Component TITLE = Component.translatable((String)"credits_and_attribution.screen.title");
    private static final Component CREDITS_BUTTON = Component.translatable((String)"credits_and_attribution.button.credits");
    private static final Component ATTRIBUTION_BUTTON = Component.translatable((String)"credits_and_attribution.button.attribution");
    private static final Component LICENSES_BUTTON = Component.translatable((String)"credits_and_attribution.button.licenses");
