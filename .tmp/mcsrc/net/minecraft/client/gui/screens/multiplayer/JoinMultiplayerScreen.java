...
extends Screen {
    ...
    public JoinMultiplayerScreen(Screen lastScreen) {
        super((Component)Component.translatable((String)"multiplayer.title"));
    ...
    protected void init() {
        ...
        this.selectButton = topFooterButtons.addChild(Button.builder((Component)Component.translatable((String)"selectServer.select"), button -> {
            ServerSelectionList.Entry entry = (ServerSelectionList.Entry)this.serverSelectionList.getSelected();
            if (entry != null) {
                entry.join();
            }
        }).width(100).build());
        topFooterButtons.addChild(Button.builder((Component)Component.translatable((String)"selectServer.direct"), button -> {
        ...
        topFooterButtons.addChild(Button.builder((Component)Component.translatable((String)"selectServer.add"), button -> {
            this.editingServer = new ServerData("", "", ServerData.Type.OTHER);
            this.minecraft.gui.setScreen(new ManageServerScreen(this, (Component)Component.translatable((String)"manageServer.add.title"), this::addServerCallback, this.editingServer));
        }).width(100).build());
        this.editButton = bottomFooterButtons.addChild(Button.builder((Component)Component.translatable((String)"selectServer.edit"), button -> {
            ServerSelectionList.Entry entry = (ServerSelectionList.Entry)this.serverSelectionList.getSelected();
            if (entry instanceof ServerSelectionList.OnlineServerEntry) {
                ...
                this.minecraft.gui.setScreen(new ManageServerScreen(this, (Component)Component.translatable((String)"manageServer.edit.title"), this::editServerCallback, this.editingServer));
            }
        }).width(74).build());
        this.deleteButton = bottomFooterButtons.addChild(Button.builder((Component)Component.translatable((String)"selectServer.delete"), button -> {
            ServerSelectionList.Entry entry = (ServerSelectionList.Entry)this.serverSelectionList.getSelected();
            if (entry instanceof ServerSelectionList.OnlineServerEntry) {
                ServerSelectionList.OnlineServerEntry onlineServerEntry = (ServerSelectionList.OnlineServerEntry)entry;
                String serverName = onlineServerEntry.getServerData().name;
                if (serverName != null) {
                    MutableComponent title = Component.translatable((String)"selectServer.deleteQuestion");
                    MutableComponent warning = Component.translatable((String)"selectServer.deleteWarning", (Object[])new Object[]{serverName});
                    MutableComponent yes = Component.translatable((String)"selectServer.deleteButton");
                    Component no = CommonComponents.GUI_CANCEL;
                    this.minecraft.gui.setScreen(new ConfirmScreen(this::deleteCallback, (Component)title, (Component)warning, (Component)yes, no));
                }
            }
        }).width(74).build());
        bottomFooterButtons.addChild(Button.builder((Component)Component.translatable((String)"selectServer.refresh"), button -> this.refreshServerList()).width(74).build());
