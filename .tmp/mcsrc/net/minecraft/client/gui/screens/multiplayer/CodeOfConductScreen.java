...
extends WarningScreen {
    private static final Component TITLE = Component.translatable((String)"multiplayer.codeOfConduct.title").withStyle(ChatFormatting.BOLD);
    private static final Component CHECK = Component.translatable((String)"multiplayer.codeOfConduct.check");
    ...
    private CodeOfConductScreen(@Nullable ServerData serverData, Screen parent, Component contents, String codeOfConductText, BooleanConsumer resultConsumer) {
        super(TITLE, contents, CHECK, (Component)TITLE.copy().append("\n").append(contents));
    ...
    public CodeOfConductScreen(@Nullable ServerData serverData, Screen parent, String codeOfConductText, BooleanConsumer resultConsumer) {
        this(serverData, parent, (Component)Component.literal((String)codeOfConductText), codeOfConductText, resultConsumer);
    }
