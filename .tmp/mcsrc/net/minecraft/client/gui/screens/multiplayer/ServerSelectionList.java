...
extends ObjectSelectionList<Entry> {
    private static final Identifier INCOMPATIBLE_SPRITE = Identifier.withDefaultNamespace((String)"server_list/incompatible");
    private static final Identifier UNREACHABLE_SPRITE = Identifier.withDefaultNamespace((String)"server_list/unreachable");
    private static final Identifier PING_1_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_1");
    private static final Identifier PING_2_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_2");
    private static final Identifier PING_3_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_3");
    private static final Identifier PING_4_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_4");
    private static final Identifier PING_5_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_5");
    private static final Identifier PINGING_1_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_1");
    private static final Identifier PINGING_2_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_2");
    private static final Identifier PINGING_3_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_3");
    private static final Identifier PINGING_4_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_4");
    private static final Identifier PINGING_5_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_5");
    private static final Identifier JOIN_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"server_list/join_highlighted");
    private static final Identifier JOIN_SPRITE = Identifier.withDefaultNamespace((String)"server_list/join");
    ...
    private static final Component SCANNING_LABEL = Component.translatable((String)"lanServer.scanning");
    private static final Component CANT_RESOLVE_TEXT = Component.translatable((String)"multiplayer.status.cannot_resolve").withColor(-65536);
    private static final Component CANT_CONNECT_TEXT = Component.translatable((String)"multiplayer.status.cannot_connect").withColor(-65536);
    private static final Component INCOMPATIBLE_STATUS = Component.translatable((String)"multiplayer.status.incompatible");
    private static final Component NO_CONNECTION_STATUS = Component.translatable((String)"multiplayer.status.no_connection");
    private static final Component PINGING_STATUS = Component.translatable((String)"multiplayer.status.pinging");
    private static final Component ONLINE_STATUS = Component.translatable((String)"multiplayer.status.online");
    ...
    public void updateNetworkServers(List<LanServer> servers) {
        ...
        for (int i = this.networkServers.size() - newServerCount; i < this.networkServers.size(); ++i) {
            ...
            this.minecraft.getNarrator().saySystemQueued((Component)Component.translatable((String)"multiplayer.lan.server_found", (Object[])new Object[]{newServer.getServerNarration()}));
        }
    }
    ...
    extends Entry {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
            this.loadingDotsWidget.setPosition(this.getContentXMiddle() - this.minecraft.font.width((FormattedText)SCANNING_LABEL) / 2, this.getContentY());
    ...
    implements SelectableEntry {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
            ...
            if (this.serverData.state() == ServerData.State.INITIAL) {
                ...
                THREAD_POOL.submit(() -> {
                    try {
                        ...
                        }, EventLoopGroupHolder.remote((boolean)this.minecraft.options.useNativeTransport()));
                    }
            ...
            List<FormattedCharSequence> lines = this.minecraft.font.split((FormattedText)this.serverData.motd, this.getContentWidth() - 32 - 2);
        ...
        public Component getNarration() {
            ...
            narrationComponent.append((Component)Component.translatable((String)"narrator.select", (Object[])new Object[]{this.serverData.name}));
            narrationComponent.append(CommonComponents.NARRATION_SEPARATOR);
            switch (this.serverData.state()) {
                case INCOMPATIBLE: {
                    narrationComponent.append(INCOMPATIBLE_STATUS);
                    narrationComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    narrationComponent.append((Component)Component.translatable((String)"multiplayer.status.version.narration", (Object[])new Object[]{this.serverData.version}));
                    narrationComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    narrationComponent.append((Component)Component.translatable((String)"multiplayer.status.motd.narration", (Object[])new Object[]{this.serverData.motd}));
                    break;
                }
                case UNREACHABLE: {
                ...
                default: {
                    ...
                    narrationComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    narrationComponent.append((Component)Component.translatable((String)"multiplayer.status.ping.narration", (Object[])new Object[]{this.serverData.ping}));
                    narrationComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    narrationComponent.append((Component)Component.translatable((String)"multiplayer.status.motd.narration", (Object[])new Object[]{this.serverData.motd}));
                    if (this.serverData.players == null) break;
                    narrationComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    narrationComponent.append((Component)Component.translatable((String)"multiplayer.status.player_count.narration", (Object[])new Object[]{this.serverData.players.online(), this.serverData.players.max()}));
                    narrationComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    narrationComponent.append(ComponentUtils.formatList(this.serverData.playerList, (Component)Component.literal((String)", ")));
                }
            }
    ...
    extends Entry {
        ...
        @Override
        public Component getNarration() {
            return Component.translatable((String)"narrator.select", (Object[])new Object[]{this.getServerNarration()});
        }
