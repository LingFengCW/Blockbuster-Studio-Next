...
extends WarningScreen {
    private static final Component TITLE = Component.translatable((String)"multiplayerWarning.header").withStyle(ChatFormatting.BOLD);
    private static final Component CONTENT = Component.translatable((String)"multiplayerWarning.message");
    private static final Component CHECK = Component.translatable((String)"multiplayerWarning.check").withColor(-2039584);
