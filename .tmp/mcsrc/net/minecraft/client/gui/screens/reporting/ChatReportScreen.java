...
extends AbstractReportScreen<ChatReport.Builder> {
    private static final Component TITLE = Component.translatable((String)"gui.chatReport.title");
    private static final Component SELECT_CHAT_MESSAGE = Component.translatable((String)"gui.chatReport.select_chat");
    ...
    protected void onReportChanged() {
        ...
        if (reportedMessages.isEmpty()) {
            ...
            this.selectMessagesButton.setMessage((Component)Component.translatable((String)"gui.chatReport.selected_chat", (Object[])new Object[]{reportedMessages.size()}));
        }
