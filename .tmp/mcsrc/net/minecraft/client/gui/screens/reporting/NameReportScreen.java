...
extends AbstractReportScreen<NameReport.Builder> {
    private static final Component TITLE = Component.translatable((String)"gui.abuseReport.name.title");
    private static final Component COMMENT_BOX_LABEL = Component.translatable((String)"gui.abuseReport.name.comment_box_label");
    ...
    protected void addContent() {
        MutableComponent reportedName = Component.literal((String)((NameReport)((NameReport.Builder)this.reportBuilder).report()).getReportedName()).withStyle(ChatFormatting.YELLOW);
        this.layout.addChild(new StringWidget((Component)Component.translatable((String)"gui.abuseReport.name.reporting", (Object[])new Object[]{reportedName}), this.font), s -> s.alignHorizontallyCenter().padding(0, 8));
