...
extends Screen {
    private static final Component REASON_TITLE = Component.translatable((String)"gui.abuseReport.reason.title");
    private static final Component REASON_DESCRIPTION = Component.translatable((String)"gui.abuseReport.reason.description");
    private static final Component READ_INFO_LABEL = Component.translatable((String)"gui.abuseReport.read_info");
    ...
    protected void init() {
        ...
        ReasonSelectionList.Entry selectedEntry = (ReasonSelectionList.Entry)Optionull.map((Object)((Object)this.currentlySelectedReason), this.reasonSelectionList::findEntry);
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (selectedEntry != null) {
            ...
            int contentHeight = this.font.wordWrapHeight((FormattedText)selectedEntry.reason.description(), textWidth);
            graphics.textWithWordWrap(this.font, (FormattedText)selectedEntry.reason.description(), textLeft, textTop + (textHeight - contentHeight) / 2, textWidth, -1);
        }
    }
    ...
    extends ObjectSelectionList<Entry> {
        ...
        extends ObjectSelectionList.Entry<Entry> {
            ...
            public Component getNarration() {
                return Component.translatable((String)"gui.abuseReport.reason.narration", (Object[])new Object[]{this.reason.title(), this.reason.description()});
            }
