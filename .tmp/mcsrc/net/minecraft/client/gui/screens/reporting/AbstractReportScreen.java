...
extends Screen {
    private static final Component REPORT_SENT_MESSAGE = Component.translatable((String)"gui.abuseReport.report_sent_msg");
    private static final Component REPORT_SENDING_TITLE = Component.translatable((String)"gui.abuseReport.sending.title").withStyle(ChatFormatting.BOLD);
    private static final Component REPORT_SENT_TITLE = Component.translatable((String)"gui.abuseReport.sent.title").withStyle(ChatFormatting.BOLD);
    private static final Component REPORT_ERROR_TITLE = Component.translatable((String)"gui.abuseReport.error.title").withStyle(ChatFormatting.BOLD);
    private static final Component REPORT_SEND_GENERIC_ERROR = Component.translatable((String)"gui.abuseReport.send.generic_error");
    protected static final Component SEND_REPORT = Component.translatable((String)"gui.abuseReport.send");
    protected static final Component OBSERVED_WHAT_LABEL = Component.translatable((String)"gui.abuseReport.observed_what");
    protected static final Component SELECT_REASON = Component.translatable((String)"gui.abuseReport.select_reason");
    private static final Component DESCRIBE_PLACEHOLDER = Component.translatable((String)"gui.abuseReport.describe");
    protected static final Component MORE_COMMENTS_LABEL = Component.translatable((String)"gui.abuseReport.more_comments");
    private static final Component MORE_COMMENTS_NARRATION = Component.translatable((String)"gui.abuseReport.comments");
    private static final Component ATTESTATION_CHECKBOX = Component.translatable((String)"gui.abuseReport.attestation").withColor(-2039584);
    ...
    protected void onReportChanged() {
        ...
        this.sendButton.setTooltip((Tooltip)Optionull.map((Object)cannotBuildReason, Report.CannotBuildReason::tooltip));
    }
    ...
    private void displayReportSendError(Component message) {
        ...
        this.minecraft.gui.setScreen(GenericWaitingScreen.createCompleted(REPORT_ERROR_TITLE, (Component)styledMessage, CommonComponents.GUI_BACK, () -> this.minecraft.gui.setScreen(this)));
    }
    ...
    extends WarningScreen {
        private static final Component TITLE = Component.translatable((String)"gui.abuseReport.discard.title").withStyle(ChatFormatting.BOLD);
        private static final Component MESSAGE = Component.translatable((String)"gui.abuseReport.discard.content");
        private static final Component RETURN = Component.translatable((String)"gui.abuseReport.discard.return");
        private static final Component DRAFT = Component.translatable((String)"gui.abuseReport.discard.draft");
        private static final Component DISCARD = Component.translatable((String)"gui.abuseReport.discard.discard");
