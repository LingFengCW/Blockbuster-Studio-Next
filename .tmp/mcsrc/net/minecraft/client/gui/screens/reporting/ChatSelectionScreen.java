...
extends Screen {
    private static final Identifier CHECKMARK_SPRITE = Identifier.withDefaultNamespace((String)"icon/checkmark");
    private static final Component TITLE = Component.translatable((String)"gui.chatSelection.title");
    private static final Component CONTEXT_INFO = Component.translatable((String)"gui.chatSelection.context");
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        MutableComponent selectedText = Component.translatable((String)"gui.chatSelection.selected", (Object[])new Object[]{messageCount, maxMessageCount});
    ...
    public Component getNarrationMessage() {
        return CommonComponents.joinForNarration((Component[])new Component[]{super.getNarrationMessage(), CONTEXT_INFO});
    }
    ...
    implements ChatSelectionLogFiller.Output {
        ...
        public void setScrollAmount(double scrollAmount) {
            ...
            if ((float)this.maxScrollAmount() > 1.0E-5f && scrollAmount <= (double)1.0E-5f && !Mth.equal((double)scrollAmount, (double)prevScrollAmount)) {
        ...
        public int getMaxVisibleEntries() {
            return Mth.positiveCeilDiv((int)this.height, (int)16);
        }
        ...
        extends Entry {
            ...
            public MessageEntry(ChatSelectionList this$1, int chatId, Component text, @Nullable Component narration, GuiMessageTag tag, boolean canReport, boolean playerMessage) {
                ...
                this.chatId = chatId;
                this.tagIcon = (GuiMessageTag.Icon)((Object)Optionull.map((Object)tag, GuiMessageTag::icon));
                this.tagHoverText = tag != null && tag.text() != null ? this$1.this$0.font.split((FormattedText)tag.text(), this$1.getRowWidth()) : null;
                this.canReport = canReport;
                this.playerMessage = playerMessage;
                FormattedText shortText = this$1.this$0.font.substrByWidth((FormattedText)text, this.getMaximumTextWidth() - this$1.this$0.font.width((FormattedText)CommonComponents.ELLIPSIS));
                if (text != shortText) {
                    this.text = FormattedText.composite((FormattedText[])new FormattedText[]{shortText, CommonComponents.ELLIPSIS});
                    this.hoverText = this$1.this$0.font.split((FormattedText)text, this$1.getRowWidth());
                } else {
                    this.text = text;
                    this.hoverText = null;
                }
            ...
            public Component getNarration() {
                return this.isSelected() ? Component.translatable((String)"narrator.select", (Object[])new Object[]{this.narration}) : this.narration;
            }
        ...
        extends Entry {
            ...
            public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
                ...
                int textWidth = this.this$1.this$0.font.width((FormattedText)this.text);
