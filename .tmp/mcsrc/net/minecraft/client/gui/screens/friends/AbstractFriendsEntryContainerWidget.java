...
extends AbstractContainerWidget {
    ...
    public AbstractFriendsEntryContainerWidget(Minecraft minecraft, FriendsOverlayScreen screen, int x, int y, int width, int height, PlayerSocialManager.PlayerData playerData, boolean showingStatus) {
        ...
        this.playerFaceWidget = new PlayerFaceWidget(24, ResolvableProfile.createUnresolved((UUID)this.playerId));
        this.nameWidget = new StringWidget((Component)Component.literal((String)this.playerName), minecraft.font);
    ...
    static Button.CreateNarration getSpriteIconNarration(Component actionDescription) {
        return supplier -> Component.translatable((String)"narrator.select", (Object[])new Object[]{actionDescription});
    }
