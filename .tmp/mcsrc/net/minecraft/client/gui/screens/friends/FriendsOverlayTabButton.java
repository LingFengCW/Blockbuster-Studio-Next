...
extends TabButton {
    private final WidgetSprites sprites = new WidgetSprites(Identifier.withDefaultNamespace((String)"friends/button"), Identifier.withDefaultNamespace((String)"friends/button_disabled"), Identifier.withDefaultNamespace((String)"friends/button_highlighted"), Identifier.withDefaultNamespace((String)"friends/button_highlighted"));
