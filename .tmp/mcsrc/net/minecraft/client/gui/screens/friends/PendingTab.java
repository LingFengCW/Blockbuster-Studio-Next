...
extends AbstractFriendsTab {
    private static final Component RECEIVED_HEADER = Component.translatable((String)"gui.friends.pending.received").withStyle(new ChatFormatting[]{ChatFormatting.BOLD, ChatFormatting.UNDERLINE});
    private static final Component SENT_HEADER = Component.translatable((String)"gui.friends.pending.sent").withStyle(new ChatFormatting[]{ChatFormatting.BOLD, ChatFormatting.UNDERLINE});
    private static final Component EMPTY_STATE = Component.translatable((String)"gui.friends.pending.empty").withStyle(ChatFormatting.GRAY);
    ...
    public Component getTabTitle() {
        return Component.translatable((String)"gui.friends.requests_count", (Object[])new Object[]{0});
    }
