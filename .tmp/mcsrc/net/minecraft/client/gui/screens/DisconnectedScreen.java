...
extends Screen {
    private static final Component TO_SERVER_LIST = Component.translatable((String)"gui.toMenu");
    private static final Component TO_TITLE = Component.translatable((String)"gui.toTitle");
    private static final Component REPORT_TO_SERVER_TITLE = Component.translatable((String)"gui.report_to_server");
    private static final Component OPEN_REPORT_DIR_TITLE = Component.translatable((String)"gui.open_report_dir");
    ...
    public Component getNarrationMessage() {
        return CommonComponents.joinForNarration((Component[])new Component[]{this.title, this.details.reason()});
    }
