...
extends AbstractTextAreaWidget {
    ...
    private static final Component PROPERTY_TITLE = Component.translatable((String)"telemetry_info.property_title").withStyle(ChatFormatting.UNDERLINE);
    ...
    public TelemetryEventWidget(int x, int y, int width, int height, Font font) {
        super(x, y, width, height, (Component)Component.empty(), AbstractScrollArea.defaultSettings(font.lineHeight));
        this.font = font;
    ...
    private void addEventType(ContentBuilder builder, TelemetryEventType eventType, boolean isDisabled) {
        ...
        builder.addHeader(this.font, this.grayOutIfDisabled((Component)Component.translatable((String)titleTranslationPattern, (Object[])new Object[]{eventType.title()}), isDisabled));
        builder.addHeader(this.font, (Component)eventType.description().withStyle(ChatFormatting.GRAY));
    ...
    private void addEventTypeProperties(TelemetryEventType eventType, ContentBuilder content, boolean isDisabled) {
        for (TelemetryProperty<?> property : eventType.properties()) {
            content.addLine(this.font, this.grayOutIfDisabled((Component)property.title(), isDisabled));
        }
    }
    ...
    private static class ContentBuilder {
        ...
        public Content build() {
            ...
            return new Content(this.layout, (Component)this.narration);
        }
    }
}
