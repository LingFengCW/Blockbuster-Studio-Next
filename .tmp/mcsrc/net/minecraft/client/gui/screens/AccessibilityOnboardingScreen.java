...
extends Screen {
    private static final Component TITLE = Component.translatable((String)"accessibility.onboarding.screen.title");
    private static final Component ONBOARDING_NARRATOR_MESSAGE = Component.translatable((String)"accessibility.onboarding.screen.narrator");
    ...
    public void init() {
        ...
        rowHelper.addChild(SpriteIconButton.builder((Component)Component.translatable((String)"options.sounds"), button -> this.closeAndSetScreen(new SoundOptionsScreen(this, this.options)), false).width(150).sprite(Identifier.withDefaultNamespace((String)"icon/music_notes"), 16, 16).build());
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (this.fadeInStart > 0.0f) {
            ...
            if (fade >= 1.0f) {
                ...
                widgetAlpha = Mth.clampedMap((float)fade, (float)0.5f, (float)1.0f, (float)0.0f, (float)1.0f);
            }
