...
extends Screen {
    ...
    public FileFixerAbortedScreen(Runnable callback, Component message) {
        super((Component)Component.translatable((String)"upgradeWorld.aborted.title"));
    ...
    protected void addButtons(LinearLayout buttonLayout) {
        ...
        this.reportBugButton = buttonLayout.addChild(Button.builder((Component)Component.translatable((String)"upgradeWorld.aborted.reportBug"), ConfirmLinkScreen.confirmLink((Screen)this, CommonLinks.SNAPSHOT_BUGS_FEEDBACK, true)).build());
    }
