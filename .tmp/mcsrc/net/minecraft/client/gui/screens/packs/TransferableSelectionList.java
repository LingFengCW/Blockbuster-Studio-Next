...
extends ObjectSelectionList<Entry> {
    private static final Identifier SELECT_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/select_highlighted");
    private static final Identifier SELECT_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/select");
    private static final Identifier UNSELECT_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/unselect_highlighted");
    private static final Identifier UNSELECT_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/unselect");
    private static final Identifier MOVE_UP_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/move_up_highlighted");
    private static final Identifier MOVE_UP_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/move_up");
    private static final Identifier MOVE_DOWN_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/move_down_highlighted");
    private static final Identifier MOVE_DOWN_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/move_down");
    private static final Component INCOMPATIBLE_TITLE = Component.translatable((String)"pack.incompatible");
    ...
    public void updateList(Stream<PackSelectionModel.Entry> entries, @Nullable PackSelectionModel.EntryBase transferredEntry) {
        this.clearEntries();
        MutableComponent header = Component.empty().append(this.title).withStyle(new ChatFormatting[]{ChatFormatting.UNDERLINE, ChatFormatting.BOLD});
        HeaderEntry headerEntry = new HeaderEntry(this, this.minecraft.font, (Component)header);
    ...
    implements SelectableEntry {
        ...
        public PackEntry(TransferableSelectionList this$0, Minecraft minecraft, TransferableSelectionList parent, PackSelectionModel.Entry pack) {
            ...
            this.descriptionWidget = new MultiLineTextWidget(ComponentUtils.mergeStyles((Component)pack.getExtendedDescription(), (Style)Style.EMPTY.withColor(-8355712)), minecraft.font);
            this.descriptionWidget.setMaxRows(2);
        }

        @Override
        public Component getNarration() {
            return Component.translatable((String)"narrator.select", (Object[])new Object[]{this.pack.getTitle()});
        }
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
            ...
            if (!this.nameWidget.getMessage().equals((Object)this.pack.getTitle())) {
                this.nameWidget.setMessage(this.pack.getTitle());
            }
            if (!this.descriptionWidget.getMessage().getContents().equals((Object)this.pack.getExtendedDescription().getContents())) {
                this.descriptionWidget.setMessage(ComponentUtils.mergeStyles((Component)this.pack.getExtendedDescription(), (Style)Style.EMPTY.withColor(-8355712)));
            }
