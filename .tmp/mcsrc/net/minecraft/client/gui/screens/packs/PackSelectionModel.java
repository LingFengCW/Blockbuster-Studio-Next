...
public class PackSelectionModel {
    ...
    public PackSelectionModel(Consumer<EntryBase> onListChanged, Function<Pack, Identifier> iconGetter, PackRepository repository, Consumer<PackRepository> output) {
        ...
        this.selected = Lists.newArrayList((Iterable)repository.getSelectedPacks());
        Collections.reverse(this.selected);
        this.unselected = Lists.newArrayList((Iterable)repository.getAvailablePacks());
    ...
    implements Entry {
        ...
        protected void toggleSelection() {
            ...
            this.pack.getDefaultPosition().insert(this.getOtherList(), (Object)this.pack, Pack::selectionConfig, true);
