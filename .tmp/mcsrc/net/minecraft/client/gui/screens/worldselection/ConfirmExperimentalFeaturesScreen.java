...
extends Screen {
    private static final Component TITLE = Component.translatable((String)"selectWorld.experimental.title");
    private static final Component MESSAGE = Component.translatable((String)"selectWorld.experimental.message");
    private static final Component DETAILS_BUTTON = Component.translatable((String)"selectWorld.experimental.details");
    ...
    public Component getNarrationMessage() {
        return CommonComponents.joinForNarration((Component[])new Component[]{super.getNarrationMessage(), MESSAGE});
    }
    ...
    extends Screen {
        private static final Component TITLE = Component.translatable((String)"selectWorld.experimental.details.title");
        ...
        extends ObjectSelectionList<PackListEntry> {
            public PackList(DetailsScreen detailsScreen, Minecraft minecraft, Collection<Pack> selectedPacks) {
                ...
                for (Pack pack : selectedPacks) {
                    String nonVanillaFeatures = FeatureFlags.printMissingFlags((FeatureFlagSet)FeatureFlags.VANILLA_SET, (FeatureFlagSet)pack.getRequestedFeatures());
                    if (nonVanillaFeatures.isEmpty()) continue;
                    Component title = ComponentUtils.mergeStyles((Component)pack.getTitle(), (Style)Style.EMPTY.withBold(Boolean.valueOf(true)));
                    MutableComponent message = Component.translatable((String)"selectWorld.experimental.details.entry", (Object[])new Object[]{nonVanillaFeatures});
                    this.addEntry(new PackListEntry(detailsScreen, title, (Component)message, MultiLineLabel.create(detailsScreen.font, (Component)message, this.getRowWidth())));
                }
            }
        ...
        extends ObjectSelectionList.Entry<PackListEntry> {
            ...
            public Component getNarration() {
                return Component.translatable((String)"narrator.select", (Object[])new Object[]{CommonComponents.joinForNarration((Component[])new Component[]{this.packId, this.message})});
            }
        }
    }
}
