...
implements Renderable {
    ...
    private static final Component SCREEN_USAGE_NARRATION = Component.translatable((String)"narrator.screen.usage");
    public static final Identifier MENU_BACKGROUND = Identifier.withDefaultNamespace((String)"textures/gui/menu_background.png");
    public static final Identifier HEADER_SEPARATOR = Identifier.withDefaultNamespace((String)"textures/gui/header_separator.png");
    public static final Identifier FOOTER_SEPARATOR = Identifier.withDefaultNamespace((String)"textures/gui/footer_separator.png");
    private static final Identifier INWORLD_MENU_BACKGROUND = Identifier.withDefaultNamespace((String)"textures/gui/inworld_menu_background.png");
    public static final Identifier INWORLD_HEADER_SEPARATOR = Identifier.withDefaultNamespace((String)"textures/gui/inworld_header_separator.png");
    public static final Identifier INWORLD_FOOTER_SEPARATOR = Identifier.withDefaultNamespace((String)"textures/gui/inworld_footer_separator.png");
    ...
    public static List<Component> getTooltipFromItem(Minecraft minecraft, ItemStack itemStack) {
        return itemStack.getTooltipLines(Item.TooltipContext.of((Level)minecraft.level), (Player)minecraft.player, (TooltipFlag)(minecraft.options.advancedItemTooltips ? TooltipFlag.Default.ADVANCED : TooltipFlag.Default.NORMAL));
    }
    ...
    protected static void defaultHandleGameClickEvent(ClickEvent event, Minecraft minecraft, @Nullable Screen activeScreen) {
        ...
        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{ClickEvent.RunCommand.class, ClickEvent.ShowDialog.class, ClickEvent.Custom.class}, (ClickEvent)clickEvent2, n)) {
            ...
            case 1: {
                ...
                player.connection.showDialog((Holder<Dialog>)dialog.dialog(), activeScreen);
                return;
            }
            case 2: {
                ClickEvent.Custom custom = (ClickEvent.Custom)clickEvent2;
                player.connection.send((Packet<?>)new ServerboundCustomClickActionPacket(custom.id(), custom.payload()));
    ...
    protected static void clickCommandAction(LocalPlayer player, String command, @Nullable Screen screenAfterCommand) {
        player.connection.sendUnattendedCommand(Commands.trimOptionalPrefix((String)command), screenAfterCommand);
    }
    ...
    protected void updateNarratedWidget(NarrationElementOutput output) {
        ...
        if (result != null) {
            ...
            if (activeNarratables.size() > 1) {
                output.add(NarratedElementType.POSITION, (Component)Component.translatable((String)"narrator.position.screen", (Object[])new Object[]{result.index + 1, activeNarratables.size()}));
    ...
    protected Component getUsageNarration() {
        return Component.translatable((String)"narration.component_list.usage");
    }
