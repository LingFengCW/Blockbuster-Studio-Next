...
public class EnchantmentNames {
    private static final FontDescription ALT_FONT = new FontDescription.Resource(Identifier.withDefaultNamespace((String)"alt"));
    ...
    public FormattedText getRandomName(Font font, int maxWidth) {
        ...
        for (int i = 0; i < wordCount; ++i) {
            ...
            result.append((String)Util.getRandom((Object[])this.words, (RandomSource)this.random));
        }
        return font.getSplitter().headByWidth((FormattedText)Component.literal((String)result.toString()).withStyle(ROOT_STYLE), maxWidth, Style.EMPTY);
    }
