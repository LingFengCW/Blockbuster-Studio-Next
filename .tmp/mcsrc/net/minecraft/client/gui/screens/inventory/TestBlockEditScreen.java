...
extends Screen {
    ...
    private static final Component TITLE = Component.translatable((String)Blocks.TEST_BLOCK.getDescriptionId());
    private static final Component MESSAGE_LABEL = Component.translatable((String)"test_block.message");
    ...
    @Override
    public void init() {
        this.messageEdit = new EditBox(this.font, this.width / 2 - 152, 80, 240, 20, (Component)Component.translatable((String)"test_block.message"));
    ...
    private void onDone() {
        ...
        this.minecraft.getConnection().send((Packet<?>)new ServerboundSetTestBlockPacket(this.position, this.mode, this.message));
        this.onClose();
    }
