...
extends Screen {
    ...
    private static final Component FINALIZE_WARNING_LABEL = Component.translatable((String)"book.finalizeWarning");
    private static final Component TITLE = Component.translatable((String)"book.sign.title");
    private static final Component TITLE_EDIT_BOX = Component.translatable((String)"book.sign.titlebox");
    ...
    @Override
    protected void init() {
        Button finalizeButton = Button.builder((Component)Component.translatable((String)"book.finalizeButton"), button -> {
            this.saveChanges();
        ...
        this.titleBox.setResponder(value -> {
            finalizeButton.active = !StringUtil.isBlank((String)value);
        });
    ...
    private void saveChanges() {
        ...
        this.minecraft.getConnection().send((Packet<?>)new ServerboundEditBookPacket(slot, this.pages, Optional.of(this.titleBox.getValue().trim())));
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        graphics.textWithWordWrap(this.font, (FormattedText)FINALIZE_WARNING_LABEL, xo + 36, 82, 114, -16777216, false);
    }
