...
extends ItemCombinerScreen<SmithingMenu> {
    private static final Identifier ERROR_SPRITE = Identifier.withDefaultNamespace((String)"container/smithing/error");
    private static final Identifier EMPTY_SLOT_SMITHING_TEMPLATE_ARMOR_TRIM = Identifier.withDefaultNamespace((String)"container/slot/smithing_template_armor_trim");
    private static final Identifier EMPTY_SLOT_SMITHING_TEMPLATE_NETHERITE_UPGRADE = Identifier.withDefaultNamespace((String)"container/slot/smithing_template_netherite_upgrade");
    private static final Component MISSING_TEMPLATE_TOOLTIP = Component.translatable((String)"container.upgrade.missing_template_tooltip");
    private static final Component ERROR_TOOLTIP = Component.translatable((String)"container.upgrade.error_tooltip");
    ...
    public SmithingScreen(SmithingMenu menu, Inventory inventory, Component title) {
        super(menu, inventory, title, Identifier.withDefaultNamespace((String)"textures/gui/container/smithing.png"));
        this.titleLabelX = 44;
        this.titleLabelY = 15;
