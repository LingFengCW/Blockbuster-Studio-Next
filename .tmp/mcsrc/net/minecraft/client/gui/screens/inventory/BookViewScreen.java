...
extends Screen {
    ...
    private static final Component TITLE = Component.translatable((String)"book.view.title");
    ...
    public static final Identifier BOOK_LOCATION = Identifier.withDefaultNamespace((String)"textures/gui/book.png");
    ...
    public void setBookAccess(BookAccess bookAccess) {
        this.bookAccess = bookAccess;
        this.currentPage = Mth.clamp((int)this.currentPage, (int)0, (int)bookAccess.getPageCount());
        this.updateButtonVisibility();
        this.cachedPage = -1;
    }

    public boolean setPage(int page) {
        int clampedPage = Mth.clamp((int)page, (int)0, (int)(this.bookAccess.getPageCount() - 1));
    ...
    public Component getNarrationMessage() {
        return CommonComponents.joinLines((Component[])new Component[]{super.getNarrationMessage(), this.getPageNumberMessage(), this.bookAccess.getPage(this.currentPage)});
    }

    private Component getPageNumberMessage() {
        return Component.translatable((String)"book.pageIndicator", (Object[])new Object[]{this.currentPage + 1, Math.max(this.getNumPages(), 1)}).withStyle(PAGE_TEXT_STYLE);
    }
    ...
    private void visitText(ActiveTextCollector collector, boolean clickableOnly) {
        if (this.cachedPage != this.currentPage) {
            Component pageText = ComponentUtils.mergeStyles((Component)this.bookAccess.getPage(this.currentPage), (Style)PAGE_TEXT_STYLE);
            this.cachedPageComponents = this.font.split((FormattedText)pageText, 114);
