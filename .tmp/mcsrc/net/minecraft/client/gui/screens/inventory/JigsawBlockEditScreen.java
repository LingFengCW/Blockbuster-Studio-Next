...
extends Screen {
    private static final Component JOINT_LABEL = Component.translatable((String)"jigsaw_block.joint_label");
    private static final Component POOL_LABEL = Component.translatable((String)"jigsaw_block.pool");
    private static final Component NAME_LABEL = Component.translatable((String)"jigsaw_block.name");
    private static final Component TARGET_LABEL = Component.translatable((String)"jigsaw_block.target");
    private static final Component FINAL_STATE_LABEL = Component.translatable((String)"jigsaw_block.final_state");
    private static final Component PLACEMENT_PRIORITY_LABEL = Component.translatable((String)"jigsaw_block.placement_priority");
    private static final Component PLACEMENT_PRIORITY_TOOLTIP = Component.translatable((String)"jigsaw_block.placement_priority.tooltip");
    private static final Component SELECTION_PRIORITY_LABEL = Component.translatable((String)"jigsaw_block.selection_priority");
    private static final Component SELECTION_PRIORITY_TOOLTIP = Component.translatable((String)"jigsaw_block.selection_priority.tooltip");
    ...
    private void sendToServer() {
        this.minecraft.getConnection().send((Packet<?>)new ServerboundSetJigsawBlockPacket(this.jigsawEntity.getBlockPos(), Identifier.parse((String)this.nameEdit.getValue()), Identifier.parse((String)this.targetEdit.getValue()), Identifier.parse((String)this.poolEdit.getValue()), this.finalStateEdit.getValue(), this.joint, this.parseAsInt(this.selectionPriorityEdit.getValue()), this.parseAsInt(this.placementPriorityEdit.getValue())));
    }
    ...
    protected void init() {
        ...
        this.jointButton.active = vertical = JigsawBlock.getFrontFacing((BlockState)this.jigsawEntity.getBlockState()).getAxis().isVertical();
        ...
        this.addRenderableWidget(new AbstractSliderButton(this, this.width / 2 - 154, 185, 100, 20, CommonComponents.EMPTY, 0.0){
            ...
            protected void updateMessage() {
                this.setMessage((Component)Component.translatable((String)"jigsaw_block.levels", (Object[])new Object[]{this.this$0.levels}));
            }

            @Override
            protected void applyValue() {
                this.this$0.levels = Mth.floor((double)Mth.clampedLerp((double)this.value, (double)0.0, (double)20.0));
            }
        });
        this.addRenderableWidget(CycleButton.onOffBuilder(this.keepJigsaws).create(this.width / 2 - 50, 185, 100, 20, (Component)Component.translatable((String)"jigsaw_block.keep_jigsaws"), (button, value) -> {
            this.keepJigsaws = value;
        }));
        this.generateButton = this.addRenderableWidget(Button.builder((Component)Component.translatable((String)"jigsaw_block.generate"), button -> {
            this.onDone();
            this.sendGenerate();
    ...
    public static boolean isValidIdentifier(String location) {
        return Identifier.tryParse((String)location) != null;
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (JigsawBlock.getFrontFacing((BlockState)this.jigsawEntity.getBlockState()).getAxis().isVertical()) {
