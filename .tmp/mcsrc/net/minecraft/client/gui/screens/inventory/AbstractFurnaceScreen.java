...
extends AbstractRecipeBookScreen<T> {
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (((AbstractFurnaceMenu)this.menu).isLit()) {
            ...
            int litProgressHeight = Mth.ceil((float)(((AbstractFurnaceMenu)this.menu).getLitProgress() * 13.0f)) + 1;
        ...
        int burnProgressWidth = Mth.ceil((float)(((AbstractFurnaceMenu)this.menu).getBurnProgress() * 24.0f));
