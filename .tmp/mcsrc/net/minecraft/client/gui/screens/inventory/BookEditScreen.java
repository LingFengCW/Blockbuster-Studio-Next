...
extends Screen {
    ...
    private static final Component TITLE = Component.translatable((String)"book.edit.title");
    private static final Component SIGN_BOOK_LABEL = Component.translatable((String)"book.signButton");
    ...
    private Component getPageNumberMessage() {
        return Component.translatable((String)"book.pageIndicator", (Object[])new Object[]{this.currentPage + 1, this.getNumPages()}).withColor(-16777216).withoutShadow();
    }
    ...
    private void saveChanges() {
        ...
        this.minecraft.getConnection().send((Packet<?>)new ServerboundEditBookPacket(slot, this.pages, Optional.empty()));
    }

    private void updateLocalCopy() {
        this.book.set(DataComponents.WRITABLE_BOOK_CONTENT, (Object)new WritableBookContent(this.pages.stream().map(Filterable::passThrough).toList()));
    }
