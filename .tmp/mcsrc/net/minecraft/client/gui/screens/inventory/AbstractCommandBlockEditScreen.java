...
extends Screen {
    ...
    protected void init() {
        ...
        this.commandEdit = new EditBox(this, this.font, this.width / 2 - 150, 50, 300, 20, (Component)Component.translatable((String)"advMode.command")){
        ...
        this.previousEdit = new EditBox(this.font, this.width / 2 - 150, this.getPreviousY(), 276, 20, (Component)Component.translatable((String)"advMode.previousOutput"));
        this.previousEdit.setMaxLength(32500);
        this.previousEdit.setEditable(false);
        this.previousEdit.setValue("-");
        this.addWidget(this.previousEdit);
        this.outputButton = this.addRenderableWidget(CycleButton.booleanBuilder((Component)Component.literal((String)"O"), (Component)Component.literal((String)"X"), trackOutput).displayOnlyValue().create(this.width / 2 + 150 - 20, this.getPreviousY(), 20, 20, (Component)Component.translatable((String)"advMode.trackOutput"), (button, value) -> {
            BaseCommandBlock commandBlock = this.getCommandBlock();
            commandBlock.setTrackOutput(value.booleanValue());
