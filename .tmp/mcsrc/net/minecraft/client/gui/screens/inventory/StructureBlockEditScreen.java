...
extends Screen {
    private static final Component NAME_LABEL = Component.translatable((String)"structure_block.structure_name");
    private static final Component POSITION_LABEL = Component.translatable((String)"structure_block.position");
    private static final Component SIZE_LABEL = Component.translatable((String)"structure_block.size");
    private static final Component INTEGRITY_LABEL = Component.translatable((String)"structure_block.integrity");
    private static final Component CUSTOM_DATA_LABEL = Component.translatable((String)"structure_block.custom_data");
    private static final Component INCLUDE_ENTITIES_LABEL = Component.translatable((String)"structure_block.include_entities");
    private static final Component STRICT_LABEL = Component.translatable((String)"structure_block.strict");
    private static final Component DETECT_SIZE_LABEL = Component.translatable((String)"structure_block.detect_size");
    private static final Component SHOW_AIR_LABEL = Component.translatable((String)"structure_block.show_air");
    private static final Component SHOW_BOUNDING_BOX_LABEL = Component.translatable((String)"structure_block.show_boundingbox");
    ...
    public StructureBlockEditScreen(StructureBlockEntity structure) {
        super((Component)Component.translatable((String)Blocks.STRUCTURE_BLOCK.getDescriptionId()));
    ...
    protected void init() {
        ...
        this.saveButton = this.addRenderableWidget(Button.builder((Component)Component.translatable((String)"structure_block.button.save"), button -> {
        ...
        this.loadButton = this.addRenderableWidget(Button.builder((Component)Component.translatable((String)"structure_block.button.load"), button -> {
            if (this.structure.getMode() == StructureMode.LOAD) {
                this.sendToServer(StructureBlockEntity.UpdateType.LOAD_AREA);
                this.minecraft.gui.setScreen(null);
            }
        }).bounds(this.width / 2 + 4 + 100, 185, 50, 20).build());
        this.addRenderableWidget(CycleButton.builder(value -> Component.translatable((String)("structure_block.mode." + value.getSerializedName())), this.initialMode).withValues((List<StructureMode>)DEFAULT_MODES, (List<StructureMode>)ALL_MODES).displayOnlyValue().create(this.width / 2 - 4 - 150, 185, 50, 20, (Component)Component.literal((String)"MODE"), (button, value) -> {
            this.structure.setMode(value);
            this.updateMode((StructureMode)value);
        }));
        this.detectButton = this.addRenderableWidget(Button.builder((Component)Component.translatable((String)"structure_block.button.detect_size"), button -> {
            if (this.structure.getMode() == StructureMode.SAVE) {
        ...
        this.strictButton = this.addRenderableWidget(CycleButton.onOffBuilder(this.structure.isStrict()).displayOnlyValue().create(this.width / 2 + 4 + 100, 120, 50, 20, STRICT_LABEL, (button, value) -> this.structure.setStrict(value.booleanValue())));
        this.mirrorButton = this.addRenderableWidget(CycleButton.builder(Mirror::symbol, this.initialMirror).withValues((Mirror[])Mirror.values()).displayOnlyValue().create(this.width / 2 - 20, 185, 40, 20, (Component)Component.literal((String)"MIRROR"), (button, value) -> this.structure.setMirror(value)));
        this.toggleAirButton = this.addRenderableWidget(CycleButton.onOffBuilder(this.structure.getShowAir()).displayOnlyValue().create(this.width / 2 + 4 + 100, 80, 50, 20, SHOW_AIR_LABEL, (button, value) -> this.structure.setShowAir(value.booleanValue())));
        this.toggleBoundingBox = this.addRenderableWidget(CycleButton.onOffBuilder(this.structure.getShowBoundingBox()).displayOnlyValue().create(this.width / 2 + 4 + 100, 80, 50, 20, SHOW_BOUNDING_BOX_LABEL, (button, value) -> this.structure.setShowBoundingBox(value.booleanValue())));
        this.rot0Button = this.addRenderableWidget(Button.builder((Component)Component.literal((String)"0"), button -> {
            this.structure.setRotation(Rotation.NONE);
            this.updateDirectionButtons();
        }).bounds(this.width / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20).build());
        this.rot90Button = this.addRenderableWidget(Button.builder((Component)Component.literal((String)"90"), button -> {
            this.structure.setRotation(Rotation.CLOCKWISE_90);
            this.updateDirectionButtons();
        }).bounds(this.width / 2 - 1 - 40 - 20, 185, 40, 20).build());
        this.rot180Button = this.addRenderableWidget(Button.builder((Component)Component.literal((String)"180"), button -> {
            this.structure.setRotation(Rotation.CLOCKWISE_180);
            this.updateDirectionButtons();
        }).bounds(this.width / 2 + 1 + 20, 185, 40, 20).build());
        this.rot270Button = this.addRenderableWidget(Button.builder((Component)Component.literal((String)"270"), button -> {
            this.structure.setRotation(Rotation.COUNTERCLOCKWISE_90);
            this.updateDirectionButtons();
        }).bounds(this.width / 2 + 1 + 40 + 1 + 20, 185, 40, 20).build());
        this.nameEdit = new EditBox(this, this.font, this.width / 2 - 152, 40, 300, 20, (Component)Component.translatable((String)"structure_block.structure_name")){
        ...
        this.posXEdit = new EditBox(this.font, this.width / 2 - 152, 80, 80, 20, (Component)Component.translatable((String)"structure_block.position.x"));
        this.posXEdit.setMaxLength(15);
        this.posXEdit.setValue(Integer.toString(minPos.getX()));
        this.addWidget(this.posXEdit);
        this.posYEdit = new EditBox(this.font, this.width / 2 - 72, 80, 80, 20, (Component)Component.translatable((String)"structure_block.position.y"));
        this.posYEdit.setMaxLength(15);
        this.posYEdit.setValue(Integer.toString(minPos.getY()));
        this.addWidget(this.posYEdit);
        this.posZEdit = new EditBox(this.font, this.width / 2 + 8, 80, 80, 20, (Component)Component.translatable((String)"structure_block.position.z"));
        ...
        this.sizeXEdit = new EditBox(this.font, this.width / 2 - 152, 120, 80, 20, (Component)Component.translatable((String)"structure_block.size.x"));
        this.sizeXEdit.setMaxLength(15);
        this.sizeXEdit.setValue(Integer.toString(maxPos.getX()));
        this.addWidget(this.sizeXEdit);
        this.sizeYEdit = new EditBox(this.font, this.width / 2 - 72, 120, 80, 20, (Component)Component.translatable((String)"structure_block.size.y"));
        this.sizeYEdit.setMaxLength(15);
        this.sizeYEdit.setValue(Integer.toString(maxPos.getY()));
        this.addWidget(this.sizeYEdit);
        this.sizeZEdit = new EditBox(this.font, this.width / 2 + 8, 120, 80, 20, (Component)Component.translatable((String)"structure_block.size.z"));
        this.sizeZEdit.setMaxLength(15);
        this.sizeZEdit.setValue(Integer.toString(maxPos.getZ()));
        this.addWidget(this.sizeZEdit);
        this.integrityEdit = new EditBox(this.font, this.width / 2 - 152, 120, 80, 20, (Component)Component.translatable((String)"structure_block.integrity.integrity"));
        ...
        this.seedEdit = new EditBox(this.font, this.width / 2 - 72, 120, 80, 20, (Component)Component.translatable((String)"structure_block.integrity.seed"));
        this.seedEdit.setMaxLength(31);
        this.seedEdit.setValue(Long.toString(this.structure.getSeed()));
        this.addWidget(this.seedEdit);
        this.dataEdit = new EditBox(this.font, this.width / 2 - 152, 120, 240, 20, (Component)Component.translatable((String)"structure_block.custom_data"));
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (mode == StructureMode.LOAD || mode == StructureMode.SAVE) {
            ...
            graphics.text(this.font, INCLUDE_ENTITIES_LABEL, this.width / 2 + 154 - this.font.width((FormattedText)INCLUDE_ENTITIES_LABEL), 150, -6250336);
        }
        if (mode == StructureMode.SAVE) {
            ...
            graphics.text(this.font, DETECT_SIZE_LABEL, this.width / 2 + 154 - this.font.width((FormattedText)DETECT_SIZE_LABEL), 110, -6250336);
            graphics.text(this.font, SHOW_AIR_LABEL, this.width / 2 + 154 - this.font.width((FormattedText)SHOW_AIR_LABEL), 70, -6250336);
        }
        if (mode == StructureMode.LOAD) {
            ...
            graphics.text(this.font, STRICT_LABEL, this.width / 2 + 154 - this.font.width((FormattedText)STRICT_LABEL), 110, -6250336);
            graphics.text(this.font, SHOW_BOUNDING_BOX_LABEL, this.width / 2 + 154 - this.font.width((FormattedText)SHOW_BOUNDING_BOX_LABEL), 70, -6250336);
        }
        if (mode == StructureMode.DATA) {
