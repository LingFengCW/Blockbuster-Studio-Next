...
extends AbstractMountInventoryScreen<NautilusInventoryMenu> {
    ...
    private static final Identifier NAUTILUS_INVENTORY_LOCATION = Identifier.withDefaultNamespace((String)"textures/gui/container/nautilus.png");
    ...
    public NautilusInventoryScreen(NautilusInventoryMenu menu, Inventory inventory, AbstractNautilus nautilus, int inventoryColumns) {
        super(menu, inventory, nautilus.getDisplayName(), inventoryColumns, (LivingEntity)nautilus);
    }
