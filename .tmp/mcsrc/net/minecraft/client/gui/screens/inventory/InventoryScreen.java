...
extends AbstractRecipeBookScreen<InventoryMenu> {
    ...
    public InventoryScreen(Player player) {
        super(player.inventoryMenu, new CraftingRecipeBookComponent((AbstractCraftingMenu)player.inventoryMenu), player.getInventory(), (Component)Component.translatable((String)"container.crafting"));
        this.titleLabelX = 97;
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        InventoryScreen.extractEntityInInventoryFollowsMouse(graphics, xo + 26, yo + 8, xo + 75, yo + 78, 30, 0.0625f, this.xMouse, this.yMouse, (LivingEntity)this.minecraft.player);
    }
