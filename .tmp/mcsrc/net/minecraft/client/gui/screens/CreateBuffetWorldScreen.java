...
extends Screen {
    private static final Component SEARCH_HINT = Component.translatable((String)"createWorld.customize.buffet.search").withStyle(EditBox.SEARCH_HINT_STYLE);
    ...
    public CreateBuffetWorldScreen(Screen parent, WorldCreationContext settings, Consumer<Holder<Biome>> applySettings) {
        super((Component)Component.translatable((String)"createWorld.customize.buffet.title"));
        this.parent = parent;
    ...
    protected void init() {
        ...
        EditBox search = header.addChild(new EditBox(this.font, 200, 15, (Component)Component.empty()));
    ...
    extends ObjectSelectionList<Entry> {
        ...
        extends ObjectSelectionList.Entry<Entry> {
            ...
            public Entry(BiomeList biomeList, Holder.Reference<Biome> biome) {
                ...
                this.name = Language.getInstance().has(translationKey) ? Component.translatable((String)translationKey) : Component.literal((String)id.toString());
            }
