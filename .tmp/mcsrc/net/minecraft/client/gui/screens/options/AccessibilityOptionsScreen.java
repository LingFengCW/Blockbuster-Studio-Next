...
extends OptionsSubScreen {
    public static final Component TITLE = Component.translatable((String)"options.accessibility.title");
    ...
    protected void init() {
        ...
        if (highContrast != null && !this.minecraft.getResourcePackRepository().getAvailableIds().contains("high_contrast")) {
            ...
            highContrast.setTooltip(Tooltip.create((Component)Component.translatable((String)"options.accessibility.high_contrast.error.tooltip")));
        }
    ...
    protected void addFooter() {
        ...
        footer.addChild(Button.builder((Component)Component.translatable((String)"options.accessibility.link"), ConfirmLinkScreen.confirmLink((Screen)this, CommonLinks.ACCESSIBILITY_HELP)).build());
