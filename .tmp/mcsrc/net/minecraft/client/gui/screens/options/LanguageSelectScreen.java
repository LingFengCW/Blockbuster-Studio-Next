...
extends OptionsSubScreen {
    private static final Component WARNING_LABEL = Component.translatable((String)"options.languageAccuracyWarning").withColor(-4539718);
    private static final int FOOTER_HEIGHT = 53;
    private static final Component SEARCH_HINT = Component.translatable((String)"gui.language.search").withStyle(EditBox.SEARCH_HINT_STYLE);
    ...
    public LanguageSelectScreen(Screen lastScreen, Options options, LanguageManager languageManager) {
        super(lastScreen, options, (Component)Component.translatable((String)"options.language.title"));
    ...
    protected void addFooter() {
        ...
        bottomButtons.addChild(Button.builder((Component)Component.translatable((String)"options.font"), button -> this.minecraft.gui.setScreen(new FontOptionsScreen(this, this.options))).build());
    ...
    extends ObjectSelectionList<Entry> {
        ...
        extends ObjectSelectionList.Entry<Entry> {
            ...
            public Component getNarration() {
                return Component.translatable((String)"narrator.select", (Object[])new Object[]{this.language});
            }
        }
    }
}
