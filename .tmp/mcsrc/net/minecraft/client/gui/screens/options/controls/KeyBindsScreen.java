...
extends OptionsSubScreen {
    private static final Component TITLE = Component.translatable((String)"controls.keybinds.title");
    ...
    protected void addFooter() {
        this.resetButton = Button.builder((Component)Component.translatable((String)"controls.resetAll"), button -> {
