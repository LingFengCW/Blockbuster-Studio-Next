...
public class SpectatorMenu {
    private static final Identifier CLOSE_SPRITE = Identifier.withDefaultNamespace((String)"spectator/close");
    private static final Identifier SCROLL_LEFT_SPRITE = Identifier.withDefaultNamespace((String)"spectator/scroll_left");
    private static final Identifier SCROLL_RIGHT_SPRITE = Identifier.withDefaultNamespace((String)"spectator/scroll_right");
    ...
    private static final Component CLOSE_MENU_TEXT = Component.translatable((String)"spectatorMenu.close");
    private static final Component PREVIOUS_PAGE_TEXT = Component.translatable((String)"spectatorMenu.previous_page");
    private static final Component NEXT_PAGE_TEXT = Component.translatable((String)"spectatorMenu.next_page");
    ...
    implements SpectatorMenuItem {
        ...
        @Override
        public void extractIcon(GuiGraphicsExtractor graphics, float brightness, float alpha) {
            graphics.blitSprite(RenderPipelines.GUI_TEXTURED, CLOSE_SPRITE, 0, 0, 16, 16, ARGB.colorFromFloat((float)alpha, (float)brightness, (float)brightness, (float)brightness));
        }
    ...
    implements SpectatorMenuItem {
        ...
        @Override
        public void extractIcon(GuiGraphicsExtractor graphics, float brightness, float alpha) {
            int color = ARGB.colorFromFloat((float)alpha, (float)brightness, (float)brightness, (float)brightness);
            if (this.direction < 0) {
