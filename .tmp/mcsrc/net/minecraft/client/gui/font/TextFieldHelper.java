...
public class TextFieldHelper {
    ...
    private int clampToMsgLength(int value) {
        return Mth.clamp((int)value, (int)0, (int)this.getMessageFn.get().length());
    }
    ...
    private void insertText(String message, String text) {
        ...
        this.cursorPos = Mth.clamp((int)this.cursorPos, (int)0, (int)message.length());
    ...
    public void moveByChars(int count, boolean selecting) {
        this.cursorPos = Util.offsetByCodepoints((String)this.getMessageFn.get(), (int)this.cursorPos, (int)count);
    ...
    public void removeCharsFromCursor(int count) {
        ...
        if (!message.isEmpty()) {
            ...
            if (this.selectionPos != this.cursorPos) {
                ...
                int otherPos = Util.offsetByCodepoints((String)message, (int)this.cursorPos, (int)count);
    ...
    public void setSelectionRange(int start, int end) {
        ...
        this.cursorPos = Mth.clamp((int)start, (int)0, (int)maxSize);
        this.selectionPos = Mth.clamp((int)end, (int)0, (int)maxSize);
    }
