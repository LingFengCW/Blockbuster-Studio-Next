...
implements ContextualBar {
    private static final Identifier JUMP_BAR_BACKGROUND_SPRITE = Identifier.withDefaultNamespace((String)"hud/jump_bar_background");
    private static final Identifier JUMP_BAR_COOLDOWN_SPRITE = Identifier.withDefaultNamespace((String)"hud/jump_bar_cooldown");
    private static final Identifier JUMP_BAR_PROGRESS_SPRITE = Identifier.withDefaultNamespace((String)"hud/jump_bar_progress");
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        int progress = Mth.lerpDiscrete((float)this.minecraft.player.getJumpRidingScale(), (int)0, (int)182);
        if (progress > 0) {
