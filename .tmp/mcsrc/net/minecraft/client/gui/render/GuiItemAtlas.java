...
implements AutoCloseable {
    ...
    public static int computeTextureSizeFor(int slotTextureSize, int requiredSlotCount) {
        ...
        int atlasSize = Mth.smallestSquareSide((int)preferredSlotCount);
        return Math.clamp((long)Mth.smallestEncompassingPowerOfTwo((int)(atlasSize * slotTextureSize)), 512, RenderSystem.getDevice().getDeviceInfo().limits().maxTextureSizeForFormat(GpuFormat.RGBA8_UNORM));
    }
