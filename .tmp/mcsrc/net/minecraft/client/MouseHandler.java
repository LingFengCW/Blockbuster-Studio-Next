                ...
                if (this.minecraft.gui.screen() == null) {
                    ...
                    if (pressed) {
                        ...
                        try {
                            ...
                            CrashReport report = CrashReport.forThrowable((Throwable)t, (String)"mouseClicked event handler");
                    ...
                    try {
                        ...
                        CrashReport report = CrashReport.forThrowable((Throwable)t, (String)"mouseReleased event handler");
                        screen.fillCrashDetails(report);
                        CrashReportCategory mouseDetails = report.addCategory("Mouse");
                        this.fillMousePositionDetails(mouseDetails, window);
                        mouseDetails.setDetail("Button", (Object)event.button());
                ...
                if (this.minecraft.gui.screen() != null) {
                    ...
                    if (this.minecraft.player.isSpectator()) {
                        if (this.minecraft.gui.hud.getSpectatorGui().isMenuActive()) {
                            ...
                            float speed = Mth.clamp((float)(this.minecraft.player.getAbilities().getFlyingSpeed() + (float)wheelXY.y * 0.005f), (float)0.0f, (float)0.2f);
        ...
        if (this.minecraft.isWindowActive()) {
            ...
            if (screen != null && this.minecraft.gui.overlay() == null && mouseMoved) {
                ...
                try {
                    ...
                    CrashReport report = CrashReport.forThrowable((Throwable)t, (String)"mouseMoved event handler");
                    screen.fillCrashDetails(report);
                    CrashReportCategory mouseDetails = report.addCategory("Mouse");
                    this.fillMousePositionDetails(mouseDetails, window);
                    throw new ReportedException(report);
                ...
                if (this.activeButton != null && this.mousePressedTime > 0.0) {
                    ...
                    try {
                        ...
                        CrashReport report = CrashReport.forThrowable((Throwable)t, (String)"mouseDragged event handler");
                        screen.fillCrashDetails(report);
                        CrashReportCategory mouseDetails = report.addCategory("Mouse");
                        this.fillMousePositionDetails(mouseDetails, window);
                        throw new ReportedException(report);
