 ...
 *  net.minecraft.world.item.equipment.trim.MaterialAssetGroup$AssetInfo
...
implements DataProvider {
    private static final Identifier TRIM_PALETTE_KEY = Identifier.withDefaultNamespace((String)"trims/color_palettes/trim_palette");
    private static final Map<String, Identifier> TRIM_PALETTE_VALUES = AtlasProvider.extractAllMaterialAssets().collect(Collectors.toMap(MaterialAssetGroup.AssetInfo::suffix, asset -> Identifier.withDefaultNamespace((String)("trims/color_palettes/" + asset.suffix()))));
    ...
    private CompletableFuture<?> storeAtlas(CachedOutput cache, Identifier atlasId, List<SpriteSource> contents) {
        return DataProvider.saveStable((CachedOutput)cache, SpriteSources.FILE_CODEC, contents, (Path)this.pathProvider.json(atlasId));
    }
