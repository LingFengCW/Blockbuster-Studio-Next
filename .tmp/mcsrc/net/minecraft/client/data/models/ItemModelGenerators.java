 ...
 *  net.minecraft.world.item.equipment.trim.TrimMaterials
 */
...
public class ItemModelGenerators {
    ...
    public static final List<TrimMaterialData> TRIM_MATERIAL_MODELS = List.of(new TrimMaterialData(MaterialAssetGroup.QUARTZ, (ResourceKey<TrimMaterial>)TrimMaterials.QUARTZ), new TrimMaterialData(MaterialAssetGroup.IRON, (ResourceKey<TrimMaterial>)TrimMaterials.IRON), new TrimMaterialData(MaterialAssetGroup.NETHERITE, (ResourceKey<TrimMaterial>)TrimMaterials.NETHERITE), new TrimMaterialData(MaterialAssetGroup.REDSTONE, (ResourceKey<TrimMaterial>)TrimMaterials.REDSTONE), new TrimMaterialData(MaterialAssetGroup.COPPER, (ResourceKey<TrimMaterial>)TrimMaterials.COPPER), new TrimMaterialData(MaterialAssetGroup.GOLD, (ResourceKey<TrimMaterial>)TrimMaterials.GOLD), new TrimMaterialData(MaterialAssetGroup.EMERALD, (ResourceKey<TrimMaterial>)TrimMaterials.EMERALD), new TrimMaterialData(MaterialAssetGroup.DIAMOND, (ResourceKey<TrimMaterial>)TrimMaterials.DIAMOND), new TrimMaterialData(MaterialAssetGroup.LAPIS, (ResourceKey<TrimMaterial>)TrimMaterials.LAPIS), new TrimMaterialData(MaterialAssetGroup.AMETHYST, (ResourceKey<TrimMaterial>)TrimMaterials.AMETHYST), new TrimMaterialData(MaterialAssetGroup.RESIN, (ResourceKey<TrimMaterial>)TrimMaterials.RESIN));
    ...
    public static Identifier prefixForSlotTrim(String slotName) {
        return Identifier.withDefaultNamespace((String)("trims/items/" + slotName + "_trim"));
    }
    ...
    private List<RangeSelectItemModel.Entry> createCompassModels(Item compass) {
        ...
        for (int i = 1; i < 32; ++i) {
            int textureIndex = Mth.positiveModulo((int)(i - 16), (int)32);
    ...
    private void generatePotion(Item item) {
        Identifier model = this.generateLayeredItem(item, new Material(Identifier.withDefaultNamespace((String)"item/potion_overlay")), TextureMapping.getItemTexture(item));
    ...
    public void run() {
        ...
        this.generateTrimmableItem(Items.TURTLE_HELMET, (ResourceKey<EquipmentAsset>)EquipmentAssets.TURTLE_SCUTE, TRIM_PREFIX_HELMET, false);
        this.generateTrimmableItem(Items.LEATHER_HELMET, (ResourceKey<EquipmentAsset>)EquipmentAssets.LEATHER, TRIM_PREFIX_HELMET, true);
        this.generateTrimmableItem(Items.LEATHER_CHESTPLATE, (ResourceKey<EquipmentAsset>)EquipmentAssets.LEATHER, TRIM_PREFIX_CHESTPLATE, true);
        this.generateTrimmableItem(Items.LEATHER_LEGGINGS, (ResourceKey<EquipmentAsset>)EquipmentAssets.LEATHER, TRIM_PREFIX_LEGGINGS, true);
        this.generateTrimmableItem(Items.LEATHER_BOOTS, (ResourceKey<EquipmentAsset>)EquipmentAssets.LEATHER, TRIM_PREFIX_BOOTS, true);
        this.generateTrimmableItem(Items.COPPER_HELMET, (ResourceKey<EquipmentAsset>)EquipmentAssets.COPPER, TRIM_PREFIX_HELMET, false);
        this.generateTrimmableItem(Items.COPPER_CHESTPLATE, (ResourceKey<EquipmentAsset>)EquipmentAssets.COPPER, TRIM_PREFIX_CHESTPLATE, false);
        this.generateTrimmableItem(Items.COPPER_LEGGINGS, (ResourceKey<EquipmentAsset>)EquipmentAssets.COPPER, TRIM_PREFIX_LEGGINGS, false);
        this.generateTrimmableItem(Items.COPPER_BOOTS, (ResourceKey<EquipmentAsset>)EquipmentAssets.COPPER, TRIM_PREFIX_BOOTS, false);
        this.generateTrimmableItem(Items.CHAINMAIL_HELMET, (ResourceKey<EquipmentAsset>)EquipmentAssets.CHAINMAIL, TRIM_PREFIX_HELMET, false);
        this.generateTrimmableItem(Items.CHAINMAIL_CHESTPLATE, (ResourceKey<EquipmentAsset>)EquipmentAssets.CHAINMAIL, TRIM_PREFIX_CHESTPLATE, false);
        this.generateTrimmableItem(Items.CHAINMAIL_LEGGINGS, (ResourceKey<EquipmentAsset>)EquipmentAssets.CHAINMAIL, TRIM_PREFIX_LEGGINGS, false);
        this.generateTrimmableItem(Items.CHAINMAIL_BOOTS, (ResourceKey<EquipmentAsset>)EquipmentAssets.CHAINMAIL, TRIM_PREFIX_BOOTS, false);
        this.generateTrimmableItem(Items.IRON_HELMET, (ResourceKey<EquipmentAsset>)EquipmentAssets.IRON, TRIM_PREFIX_HELMET, false);
        this.generateTrimmableItem(Items.IRON_CHESTPLATE, (ResourceKey<EquipmentAsset>)EquipmentAssets.IRON, TRIM_PREFIX_CHESTPLATE, false);
        this.generateTrimmableItem(Items.IRON_LEGGINGS, (ResourceKey<EquipmentAsset>)EquipmentAssets.IRON, TRIM_PREFIX_LEGGINGS, false);
        this.generateTrimmableItem(Items.IRON_BOOTS, (ResourceKey<EquipmentAsset>)EquipmentAssets.IRON, TRIM_PREFIX_BOOTS, false);
        this.generateTrimmableItem(Items.DIAMOND_HELMET, (ResourceKey<EquipmentAsset>)EquipmentAssets.DIAMOND, TRIM_PREFIX_HELMET, false);
        this.generateTrimmableItem(Items.DIAMOND_CHESTPLATE, (ResourceKey<EquipmentAsset>)EquipmentAssets.DIAMOND, TRIM_PREFIX_CHESTPLATE, false);
        this.generateTrimmableItem(Items.DIAMOND_LEGGINGS, (ResourceKey<EquipmentAsset>)EquipmentAssets.DIAMOND, TRIM_PREFIX_LEGGINGS, false);
        this.generateTrimmableItem(Items.DIAMOND_BOOTS, (ResourceKey<EquipmentAsset>)EquipmentAssets.DIAMOND, TRIM_PREFIX_BOOTS, false);
        this.generateTrimmableItem(Items.GOLDEN_HELMET, (ResourceKey<EquipmentAsset>)EquipmentAssets.GOLD, TRIM_PREFIX_HELMET, false);
        this.generateTrimmableItem(Items.GOLDEN_CHESTPLATE, (ResourceKey<EquipmentAsset>)EquipmentAssets.GOLD, TRIM_PREFIX_CHESTPLATE, false);
        this.generateTrimmableItem(Items.GOLDEN_LEGGINGS, (ResourceKey<EquipmentAsset>)EquipmentAssets.GOLD, TRIM_PREFIX_LEGGINGS, false);
        this.generateTrimmableItem(Items.GOLDEN_BOOTS, (ResourceKey<EquipmentAsset>)EquipmentAssets.GOLD, TRIM_PREFIX_BOOTS, false);
        this.generateTrimmableItem(Items.NETHERITE_HELMET, (ResourceKey<EquipmentAsset>)EquipmentAssets.NETHERITE, TRIM_PREFIX_HELMET, false);
        this.generateTrimmableItem(Items.NETHERITE_CHESTPLATE, (ResourceKey<EquipmentAsset>)EquipmentAssets.NETHERITE, TRIM_PREFIX_CHESTPLATE, false);
        this.generateTrimmableItem(Items.NETHERITE_LEGGINGS, (ResourceKey<EquipmentAsset>)EquipmentAssets.NETHERITE, TRIM_PREFIX_LEGGINGS, false);
        this.generateTrimmableItem(Items.NETHERITE_BOOTS, (ResourceKey<EquipmentAsset>)EquipmentAssets.NETHERITE, TRIM_PREFIX_BOOTS, false);
