...
public class ModelTemplates {
    ...
    private static ModelTemplate create(String id, TextureSlot ... slots) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace((String)("block/" + id))), Optional.empty(), slots);
    }

    private static ModelTemplate createItem(String id, TextureSlot ... slots) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace((String)("item/" + id))), Optional.empty(), slots);
    }

    private static ModelTemplate createItem(String id, String suffix, TextureSlot ... slots) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace((String)("item/" + id))), Optional.of(suffix), slots);
    }

    private static ModelTemplate create(String id, String suffix, TextureSlot ... slots) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace((String)("block/" + id))), Optional.of(suffix), slots);
    }
}
