...
public class FormattedBidiReorder {
    public static FormattedCharSequence reorder(FormattedText text, boolean defaultRightToLeft) {
        SubStringSource source = SubStringSource.create((FormattedText)text, UCharacter::getMirror, FormattedBidiReorder::shape);
        ...
        return FormattedCharSequence.composite((List)result);
    }
