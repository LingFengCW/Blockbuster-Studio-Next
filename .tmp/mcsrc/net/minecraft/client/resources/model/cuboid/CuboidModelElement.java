...
public record CuboidModelElement(Vector3fc from, Vector3fc to, Map<Direction, CuboidFace> faces, @Nullable CuboidRotation rotation, boolean shade, int lightEmission) {
    ...
    implements JsonDeserializer<CuboidModelElement> {
        ...
        public CuboidModelElement deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            if (object.has(FIELD_SHADE) && !GsonHelper.isBooleanValue((JsonObject)object, (String)FIELD_SHADE)) {
                throw new JsonParseException("Expected 'shade' to be a Boolean");
            }
            boolean shade = GsonHelper.getAsBoolean((JsonObject)object, (String)FIELD_SHADE, (boolean)true);
            int lightEmission = 0;
            if (object.has(FIELD_LIGHT_EMISSION)) {
                boolean isNumber = GsonHelper.isNumberValue((JsonObject)object, (String)FIELD_LIGHT_EMISSION);
                if (isNumber) {
                    lightEmission = GsonHelper.getAsInt((JsonObject)object, (String)FIELD_LIGHT_EMISSION);
                }
        ...
        private @Nullable CuboidRotation getRotation(JsonObject object) {
            if (object.has(FIELD_ROTATION)) {
                ...
                JsonObject rotationObject = GsonHelper.getAsJsonObject((JsonObject)object, (String)FIELD_ROTATION);
                ...
                if (rotationObject.has(FIELD_AXIS) || rotationObject.has(FIELD_ANGLE)) {
                    ...
                    float angle = GsonHelper.getAsFloat((JsonObject)rotationObject, (String)FIELD_ANGLE);
                    ...
                    float x = GsonHelper.getAsFloat((JsonObject)rotationObject, (String)FIELD_X, (float)0.0f);
                    float y = GsonHelper.getAsFloat((JsonObject)rotationObject, (String)FIELD_Y, (float)0.0f);
                    float z = GsonHelper.getAsFloat((JsonObject)rotationObject, (String)FIELD_Z, (float)0.0f);
                ...
                boolean rescale = GsonHelper.getAsBoolean((JsonObject)rotationObject, (String)FIELD_RESCALE, (boolean)false);
        ...
        private Direction.Axis getAxis(JsonObject object) {
            String axisName = GsonHelper.getAsString((JsonObject)object, (String)FIELD_AXIS);
            Direction.Axis axis = Direction.Axis.byName((String)axisName.toLowerCase(Locale.ROOT));
            if (axis == null) {
        ...
        private Map<Direction, CuboidFace> filterNullFromFaces(JsonDeserializationContext context, JsonObject object) {
            ...
            JsonObject faceObjects = GsonHelper.getAsJsonObject((JsonObject)object, (String)FIELD_FACES);
        ...
        private Direction getFacing(String name) {
            Direction direction = Direction.byName((String)name);
            if (direction == null) {
