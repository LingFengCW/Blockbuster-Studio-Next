...
public class MissingCuboidModel {
    ...
    public static final Identifier LOCATION = Identifier.withDefaultNamespace((String)"builtin/missing");

    public static UnbakedModel missingModel() {
        CuboidFace.UVs fullFaceUv = new CuboidFace.UVs(0.0f, 0.0f, 16.0f, 16.0f);
        Map faces = Util.makeEnumMap(Direction.class, direction -> new CuboidFace((Direction)direction, -1, TEXTURE_SLOT, fullFaceUv, Quadrant.R0));
