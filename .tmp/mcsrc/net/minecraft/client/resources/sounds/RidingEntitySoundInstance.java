...
extends AbstractTickableSoundInstance {
    ...
    public void tick() {
        ...
        this.volume = speed >= 0.01f && this.shoudlPlaySound() ? this.volumeAmplifier * Mth.clampedLerp((float)speed, (float)this.volumeMin, (float)this.volumeMax) : this.volumeMin;
    }
}
