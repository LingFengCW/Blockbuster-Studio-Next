...
implements AmbientSoundHandler {
    ...
    public void tick() {
        ...
        ambientSounds.mood().ifPresent(mood -> {
            ...
            BlockPos blockSamplingPos = BlockPos.containing((double)(this.player.getX() + (double)this.random.nextInt(searchSpan) - (double)mood.blockSearchExtent()), (double)(this.player.getEyeY() + (double)this.random.nextInt(searchSpan) - (double)mood.blockSearchExtent()), (double)(this.player.getZ() + (double)this.random.nextInt(searchSpan) - (double)mood.blockSearchExtent()));
