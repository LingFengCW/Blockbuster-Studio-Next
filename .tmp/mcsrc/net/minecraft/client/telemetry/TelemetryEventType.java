...
public class TelemetryEventType {
    ...
    private MutableComponent makeTranslation(String suffix) {
        return Component.translatable((String)("telemetry.event." + this.id + "." + suffix));
    }
    ...
    public static boolean selfTest() {
        ...
        for (Map.Entry<String, TelemetryEventType> entry : REGISTRY.entrySet()) {
            ...
            if (!ComponentUtils.isTranslationResolvable((Component)type.description()) || !ComponentUtils.isTranslationResolvable((Component)type.title())) {
        ...
        for (TelemetryProperty telemetryProperty : allProperties) {
            if (ComponentUtils.isTranslationResolvable((Component)telemetryProperty.title())) continue;
