...
public class InputConstants {
    ...
    public static enum Type {
        KEYSYM("key.keyboard", (value, name) -> {
            ...
            return systemName != null ? Component.literal((String)systemName.toUpperCase(Locale.ROOT)) : Component.translatable((String)name);
        }),
        SCANCODE("scancode", (value, name) -> {
            String systemName = GLFW.glfwGetKeyName((int)-1, (int)value);
            return systemName != null ? Component.literal((String)systemName) : Component.translatable((String)name);
        }),
        MOUSE("key.mouse", (value, name) -> Language.getInstance().has(name) ? Component.translatable((String)name) : Component.translatable((String)"key.mouse", (Object[])new Object[]{value + 1}));
