...
public class NativeLibrariesBootstrap {
    ...
    public static void loadLibraries() throws IOException {
        ...
        try {
            ...
            CrashReport crashReport = CrashReport.forThrowable((Throwable)t, (String)"Loading libraries");
            ...
            librariesLoaded.setDetail("Loading index", (Object)Integer.toString(libraryIndex));
    ...
    private static void loadLibrary(Supplier<String> debugCapture, String name, Runnable loader) {
        try {
            ...
            CrashReport crashReport = CrashReport.forThrowable((Throwable)t, (String)("Loading library " + name));
            ...
            try {
                lwjglDebugLog.setDetail("Log", (Object)debugCapture.get());
            }
            catch (Throwable e) {
                lwjglDebugLog.setDetail("Log", (Object)e);
            }
            throw new ReportedException(crashReport);
        }
    }
    ...
    private static String identifyFileContents(Path path) {
        try {
            if (Files.isRegularFile(path, new LinkOption[0])) {
                ...
                if (path.getFileName().toString().endsWith(".dll") && (detailedModuleInfo = NativeModuleLister.tryGetModuleVersion((String)path.toString()).map(NativeModuleLister.NativeModuleVersion::toString)).isPresent()) {
