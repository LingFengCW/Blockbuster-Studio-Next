...
extends RealmsScreen {
    ...
    public static final Component TITLE = Component.translatable((String)"mco.upload.select.world.title");
    private static final Component UNABLE_TO_LOAD_WORLD = Component.translatable((String)"selectWorld.unable_to_load");
    ...
    public void init() {
        ...
        this.searchBox = header.addChild(new EditBox(this.font, this.width / 2 - 100, 22, 200, 20, this.searchBox, (Component)Component.translatable((String)"selectWorld.search")));
        ...
        try {
            ...
            this.minecraft.gui.setScreen(new RealmsGenericErrorScreen(UNABLE_TO_LOAD_WORLD, Component.nullToEmpty((String)e.getMessage()), this.lastScreen));
            return;
        }
        LinearLayout footer = this.layout.addToFooter(LinearLayout.horizontal().spacing(8));
        footer.defaultCellSetting().alignHorizontallyCenter();
        this.uploadButton = footer.addChild(Button.builder((Component)Component.translatable((String)"mco.upload.button.name"), button -> this.list.getSelectedOpt().ifPresent(this::upload)).build());
