...
implements RealmsWorldUploadStatusTracker {
    ...
    private static final Component VERIFYING_TEXT = Component.translatable((String)"mco.upload.verifying");
    ...
    private volatile Component status = Component.translatable((String)"mco.upload.preparing");
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int xm, int ym, float a) {
        ...
        if (this.showDots) {
            graphics.text(this.font, DOTS[this.tickCount / 10 % DOTS.length], this.width / 2 + this.font.width((FormattedText)this.status) / 2 + 5, 50, -1);
        }
    ...
    private void extractProgressBar(GuiGraphicsExtractor graphics) {
        ...
        graphics.centeredText(this.font, (Component)Component.translatable((String)"mco.upload.percent", (Object[])new Object[]{this.progress}), this.width / 2, 84, -1);
    }
    ...
    private Component createProgressNarrationMessage() {
        ...
        if (this.progress != null) {
            elements.add(Component.translatable((String)"mco.upload.percent", (Object[])new Object[]{this.progress}));
        }
        if ((errorMessages = this.errorMessage) != null) {
        ...
        newUpload.packAndUpload().handleAsync((result, exception) -> {
            if (exception != null) {
                ...
                if (exception instanceof RealmsUploadException) {
                    ...
                    this.status = Component.translatable((String)"mco.upload.failed", (Object[])new Object[]{exception.getMessage()});
                }
            } else {
                this.status = Component.translatable((String)"mco.upload.done");
    ...
    public void setUploading() {
        this.status = Component.translatable((String)"mco.upload.uploading", (Object[])new Object[]{this.selectedLevel.getLevelName()});
    }
}
