...
extends RealmsScreen {
    private static final Component MESSAGE = Component.translatable((String)"mco.account.privacy.information");
    ...
    public void init() {
        ...
        MutableComponent privacyInfo = Component.translatable((String)"mco.account.privacy.info.button");
        buttonLayout.addChild(Button.builder((Component)privacyInfo, ConfirmLinkScreen.confirmLink((Screen)this, CommonLinks.GDPR)).build());
