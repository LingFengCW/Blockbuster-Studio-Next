...
extends Screen {
    private static final Component REGION_SELECTION_LABEL = Component.translatable((String)"mco.configure.world.region_preference.title");
    ...
    extends ObjectSelectionList<Entry> {
        ...
        extends ObjectSelectionList.Entry<Entry> {
            ...
            public Entry(RegionSelectionList regionSelectionList, RealmsSettingsTab.RegionSelection regionSelection) {
                ...
                this.name = regionSelection.preference() == RegionSelectionPreference.MANUAL ? (regionSelection.region() != null ? Component.translatable((String)regionSelection.region().translationKey) : Component.empty()) : Component.translatable((String)regionSelection.preference().translationKey);
            }
