...
implements RealmsConfigurationTab {
    ...
    public static final Component TITLE = Component.translatable((String)"mco.configure.world.settings.title");
    private static final Component NAME_LABEL = Component.translatable((String)"mco.configure.world.name");
    private static final Component DESCRIPTION_LABEL = Component.translatable((String)"mco.configure.world.description");
    private static final Component REGION_PREFERENCE_LABEL = Component.translatable((String)"mco.configure.world.region_preference");
    private static final Tooltip REALM_NAME_VALIDATION_ERROR_TOOLTIP = Tooltip.create((Component)Component.translatable((String)"mco.configure.world.name.validation.whitespace"));
    ...
    public RealmsSettingsTab(RealmsConfigureWorldScreen configurationScreen, Minecraft minecraft, RealmsServer serverData, Map<RealmsRegion, ServiceQuality> regionServiceQuality) {
        ...
        this.nameEdit = new EditBox(minecraft.font, 0, 0, 212, 20, (Component)Component.translatable((String)"mco.configure.world.name"));
        ...
        this.descEdit = new EditBox(minecraft.font, 0, 0, 212, 20, (Component)Component.translatable((String)"mco.configure.world.description"));
        ...
        this.selectedRegionStringWidget = selectedRegion.addChild(new StringWidget(192, configurationScreen.getFont().lineHeight, (Component)Component.empty(), configurationScreen.getFont()));
        ...
        helper.addChild(Button.builder((Component)Component.translatable((String)"mco.configure.world.buttons.region_preference"), button -> this.openPreferenceSelector()).bounds(0, 0, 212, 20).build());
        helper.addChild(SpacerElement.height(2));
        this.closeOpenButton = helper.addChild(Button.builder((Component)Component.empty(), button -> {
            if (serverData.state == RealmsServer.State.OPEN) {
                minecraft.gui.setScreen(RealmsPopups.customPopupScreen(configurationScreen, (Component)Component.translatable((String)"mco.configure.world.close.question.title"), (Component)Component.translatable((String)"mco.configure.world.close.question.line1"), popup -> {
                    this.save();
    ...
    private static MutableComponent getTranslatableFromPreference(RegionSelection regionSelection) {
        return (regionSelection.preference().equals((Object)RegionSelectionPreference.MANUAL) && regionSelection.region() != null ? Component.translatable((String)regionSelection.region().translationKey) : Component.translatable((String)regionSelection.preference().translationKey)).withStyle(ChatFormatting.GRAY);
    }
    ...
    private void updateRegionPreferenceValues() {
        this.selectedRegionStringWidget.setMessage((Component)RealmsSettingsTab.getTranslatableFromPreference(this.preferredRegionSelection));
    ...
    public void updateData(RealmsServer serverData) {
        ...
        this.closeOpenButton.setMessage((Component)Component.translatable((String)key));
