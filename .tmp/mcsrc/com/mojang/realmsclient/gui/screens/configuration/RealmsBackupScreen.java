...
extends RealmsScreen {
    ...
    private static final Component TITLE = Component.translatable((String)"mco.configure.world.backup");
    private static final Component RESTORE_TOOLTIP = Component.translatable((String)"mco.backup.button.restore");
    private static final Component HAS_CHANGES_TOOLTIP = Component.translatable((String)"mco.backup.changes.tooltip");
    private static final Component NO_BACKUPS_LABEL = Component.translatable((String)"mco.backup.nobackups");
    private static final Component DOWNLOAD_LATEST = Component.translatable((String)"mco.backup.button.download");
    private static final String UPLOADED_KEY = "uploaded";
    private static final int PADDING = 8;
    public static final DateTimeFormatter SHORT_DATE_FORMAT = Util.localizedDateFormatter((FormatStyle)FormatStyle.SHORT);
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (this.noBackups && this.backupList != null) {
            graphics.text(this.font, NO_BACKUPS_LABEL, this.width / 2 - this.font.width((FormattedText)NO_BACKUPS_LABEL) / 2, this.backupList.getY() + this.backupList.getHeight() / 2 - this.font.lineHeight / 2, -1);
        }
    }
    ...
    extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        public Entry(RealmsBackupScreen realmsBackupScreen, Backup backup) {
            ...
            if (!backup.changeList.isEmpty()) {
                this.changesButton = Button.builder(HAS_CHANGES_TOOLTIP, button -> ((RealmsBackupScreen)this$0).minecraft.gui.setScreen(new RealmsBackupInfoScreen(realmsBackupScreen, this.backup))).width(8 + realmsBackupScreen.font.width((FormattedText)HAS_CHANGES_TOOLTIP)).createNarration(this::narrationForBackupEntry).build();
                this.children.add(this.changesButton);
            }
            if (!realmsBackupScreen.serverData.expired) {
                this.restoreButton = Button.builder(RESTORE_TOOLTIP, button -> this.restoreClicked()).width(8 + realmsBackupScreen.font.width((FormattedText)HAS_CHANGES_TOOLTIP)).createNarration(this::narrationForBackupEntry).build();
        ...
        private MutableComponent narrationForBackupEntry(Supplier<MutableComponent> defaultNarrationSupplier) {
            return CommonComponents.joinForNarration((Component[])new Component[]{Component.translatable((String)"mco.backup.narration", (Object[])new Object[]{SHORT_DATE_FORMAT.format(this.backup.lastModifiedDate())}), (Component)defaultNarrationSupplier.get()});
        }
        ...
        private void restoreClicked() {
            ...
            MutableComponent popupMessage = Component.translatable((String)"mco.configure.world.restore.question.line1", (Object[])new Object[]{lastModifiedDate, age});
            ((RealmsBackupScreen)this.this$0).minecraft.gui.setScreen(RealmsPopups.warningPopupScreen(this.this$0, (Component)popupMessage, popupScreen -> {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
            ...
            graphics.text(this.this$0.font, (Component)Component.translatable((String)"mco.backup.entry", (Object[])new Object[]{RealmsUtil.convertToAgePresentationFromInstant(this.backup.lastModified)}), this.getContentX(), firstLineYPos, color);
