...
implements RealmsConfigurationTab {
    static final Component TITLE = Component.translatable((String)"mco.configure.worlds.title");
    ...
    public RealmsWorldsTab(RealmsConfigureWorldScreen configurationScreen, Minecraft minecraft, RealmsServer serverData) {
        ...
        this.optionsButton = buttons.addChild(Button.builder((Component)Component.translatable((String)"mco.configure.world.buttons.options"), button -> minecraft.gui.setScreen(new RealmsSlotOptionsScreen(configurationScreen, serverData.slots.get(serverData.activeSlot).copy(), serverData.worldType, serverData.activeSlot))).bounds(0, 0, 150, 20).build());
        this.backupButton = buttons.addChild(Button.builder((Component)Component.translatable((String)"mco.configure.world.backup"), button -> minecraft.gui.setScreen(new RealmsBackupScreen(configurationScreen, serverData.copy(), serverData.activeSlot))).bounds(0, 0, 150, 20).build());
        this.resetWorldButton = buttons.addChild(Button.builder((Component)Component.empty(), button -> this.resetButtonPressed()).bounds(0, 0, 150, 20).build());
    ...
    private void resetButtonPressed() {
        if (this.isMinigame()) {
            this.minecraft.gui.setScreen(new RealmsSelectWorldTemplateScreen((Component)Component.translatable((String)"mco.template.title.minigame"), this::templateSelectionCallback, RealmsServer.WorldType.MINIGAME, null));
        } else {
    ...
    public void updateData(RealmsServer serverData) {
        ...
        if (this.isMinigame()) {
            this.resetWorldButton.setMessage((Component)Component.translatable((String)"mco.configure.world.buttons.switchminigame"));
        } else {
            boolean emptySlot;
            ...
            if (emptySlot) {
                this.resetWorldButton.setMessage((Component)Component.translatable((String)"mco.configure.world.buttons.newworld"));
            } else {
                this.resetWorldButton.setMessage((Component)Component.translatable((String)"mco.configure.world.buttons.resetworld"));
            }
        }
    ...
    private void switchToMinigame() {
        RealmsSelectWorldTemplateScreen screen = new RealmsSelectWorldTemplateScreen((Component)Component.translatable((String)"mco.template.title.minigame"), this::templateSelectionCallback, RealmsServer.WorldType.MINIGAME, null, List.of(Component.translatable((String)"mco.minigame.world.info.line1").withColor(-4539718), Component.translatable((String)"mco.minigame.world.info.line2").withColor(-4539718)));
        this.minecraft.gui.setScreen(screen);
    }

    private void switchToFullSlot(int selectedSlot, RealmsServer serverData) {
        this.minecraft.gui.setScreen(RealmsPopups.infoPopupScreen(this.configurationScreen, (Component)Component.translatable((String)"mco.configure.world.slot.switch.question.line1"), popup -> {
            RealmsConfigureWorldScreen newScreen = this.configurationScreen.getNewScreen();
            this.configurationScreen.stateChanged();
    ...
    private void switchToEmptySlot(int selectedSlot, RealmsServer serverData) {
        this.minecraft.gui.setScreen(RealmsPopups.infoPopupScreen(this.configurationScreen, (Component)Component.translatable((String)"mco.configure.world.slot.switch.question.line1"), popupScreen -> {
            this.configurationScreen.stateChanged();
