...
extends RealmsScreen {
    private static final Component TITLE = Component.translatable((String)"mco.configure.world.buttons.invite");
    private static final Component NAME_LABEL = Component.translatable((String)"mco.configure.world.invite.profile.name").withColor(-6250336);
    private static final Component INVITING_PLAYER_TEXT = Component.translatable((String)"mco.configure.world.players.inviting").withColor(-6250336);
    private static final Component NO_SUCH_PLAYER_ERROR_TEXT = Component.translatable((String)"mco.configure.world.players.error").withColor(-65536);
    private static final Component DUPLICATE_PLAYER_TEXT = Component.translatable((String)"mco.configure.world.players.invite.duplicate").withColor(-65536);
    ...
    public void init() {
        ...
        this.profileName = new EditBox(this.minecraft.font, 200, 20, (Component)Component.translatable((String)"mco.configure.world.invite.profile.name"));
    ...
    private void onInvite() {
        ...
        if (StringUtil.isBlank((String)this.profileName.getValue())) {
        ...
        CompletableFuture.supplyAsync(() -> this.configureScreen.invitePlayer(serverId, name), (Executor)Util.ioPool()).thenAcceptAsync(success -> {
