...
extends RealmsScreen {
    ...
    private static final Component TITLE = Component.translatable((String)"mco.configure.world.buttons.options");
    private static final Component WORLD_NAME_EDIT_LABEL = Component.translatable((String)"mco.configure.world.edit.slot.name");
    private static final Component SPAWN_PROTECTION_TEXT = Component.translatable((String)"mco.configure.world.spawnProtection");
    private static final Component GAME_MODE_BUTTON = Component.translatable((String)"selectWorld.gameMode");
    private static final Component DIFFICULTY_BUTTON = Component.translatable((String)"options.difficulty");
    private static final Component FORCE_GAME_MODE_BUTTON = Component.translatable((String)"mco.configure.world.forceGameMode");
    ...
    public void init() {
        ...
        switch (this.worldType) {
            case ADVENTUREMAP: {
                MutableComponent mutableComponent = Component.translatable((String)"mco.configure.world.edit.subscreen.adventuremap").withColor(-65536);
                break;
            }
            case INSPIRATION: {
                MutableComponent mutableComponent = Component.translatable((String)"mco.configure.world.edit.subscreen.inspiration").withColor(-65536);
                break;
            }
            case EXPERIENCE: {
                MutableComponent mutableComponent = Component.translatable((String)"mco.configure.world.edit.subscreen.experience").withColor(-65536);
                break;
            }
            default: {
        ...
        if (warning != null) {
            ...
            this.warningHeader = header.addChild(new StringWidget((Component)warning, this.font));
        }
    ...
    public Component getNarrationMessage() {
        ...
        return CommonComponents.joinForNarration((Component[])new Component[]{this.getTitle(), this.warningHeader.getMessage()});
    }
    ...
    extends AbstractSliderButton {
        ...
        public SettingsSlider(RealmsSlotOptionsScreen realmsSlotOptionsScreen, int x, int y, int width, int currentValue, float minValue, float maxValue) {
            ...
            this.value = (Mth.clamp((float)currentValue, (float)minValue, (float)maxValue) - minValue) / (maxValue - minValue);
            this.updateMessage();
        }
        ...
        public void applyValue() {
            ...
            this.this$0.spawnProtection = (int)Mth.lerp((double)Mth.clamp((double)this.value, (double)0.0, (double)1.0), (double)this.minValue, (double)this.maxValue);
        }

        @Override
        protected void updateMessage() {
            this.setMessage((Component)CommonComponents.optionNameValue((Component)SPAWN_PROTECTION_TEXT, (Component)(this.this$0.spawnProtection == 0 ? CommonComponents.OPTION_OFF : Component.literal((String)String.valueOf(this.this$0.spawnProtection)))));
        }
    }
}
