...
public class RealmsNotification {
    ...
    private static final Component BUTTON_TEXT_FALLBACK = Component.translatable((String)"mco.notification.visitUrl.buttonText.default");
    ...
    public static List<RealmsNotification> parseList(String json) {
        ...
        try {
            JsonArray array = LenientJsonParser.parse((String)json).getAsJsonObject().get("notifications").getAsJsonArray();
    ...
    extends RealmsNotification {
        ...
        public Component getMessage() {
            return this.message.createComponent((Component)Component.translatable((String)"mco.notification.visitUrl.message.default"));
        }
    ...
    extends RealmsNotification {
        ...
        public static InfoPopup parse(RealmsNotification base, JsonObject object) {
            ...
            Identifier image = Identifier.parse((String)JsonUtils.getRequiredString(IMAGE, object));
