    ...
    public record Result(Type type, @Nullable RealmsServiceException exception) {
        ...
        public @Nullable Screen createErrorScreen(Screen lastScreen) {
            return switch (this.type.ordinal()) {
                ...
                case 3 -> new RealmsGenericErrorScreen((Component)Component.translatable((String)"mco.error.invalid.session.title"), (Component)Component.translatable((String)"mco.error.invalid.session.message"), lastScreen);
